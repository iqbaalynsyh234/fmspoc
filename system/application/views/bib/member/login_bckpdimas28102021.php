...
<body>
	...
	<div class="size1 overlay1" >
		...
		<div class="w-full flex-w flex-sb-m p-l-90 justify-content-center" style="background-color:#fff" >
			<div class="wrappic1 m-r-80 m-l-0 m-t-10 m-b-5 img2"  >
		...
		<div class="container" style="margin-top:-70px;">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form class="signin-form" id="frmlogin" name="frmlogin" onsubmit="javascript : return frmlogin_onsubmit(this);">
		      		<div class="form-group">
						...
						<span class="fa fa-fw fa-lock field-icon toggle-password"></span>
		      		</div>
	            <div class="form-group">
	            ...
	            <div class="form-group">
	            	<button type="submit" class="form-control btn submit px-3" style="background-color:grey;">Log In</button>
	            ...
	            <div class="form-group d-md-flex">
					...
					<table>
					<tr align="center">
						<td style="width:200px;"><a href="mailto:digitech@samantha.id" style="color:#fff; ">Register</a></td><td style="width:200px;" ><a href="https://api.whatsapp.com/send?phone=+628558208484&text=Saya%20ingin%20merubah%20password." target="_blank" style="color:#fff;">Forgot Password</a></td>
					</tr>
				</table>
	            </div>
	          </form>
	          ...
	          <div class="social">
				...
				<a href="#" class="btn btn-danger"><i style="float: left;"><img src="<?php echo base_url(); ?>assets/temanindobara/images/search.png"></i>GOOGLE</a>
	          </div>
