...
<div class="page-content-wrapper">
  <div class="page-content">
    ...
    <div class="col-md-12">
      <div class="panel" id="panel_form">
        <header class="panel-heading panel-heading-red">DASHBOARD EXCA ON DUTY</header>
        <div class="panel-body" id="bar-parent10">
          ...
          <div class="row">
            ...
            <!--<div class="col-md-2 col-sm-5">
              <select id="exca" name="exca" class="form-control select2" onchange="dtdatechange()">
                <option value="0">-- All Exca</option>
               
                <?php $nr = count($runit);

                for ($z = 0; $z < $nr; $z++) {
                 
                      echo "<option value=\"" . $runit[$z]->vehicle_no . "\">" . $runit[$z]->vehicle_no . " </option>";
  ...
  <script type="text/javascript">
    function dtdatechange() {
      ...
      $("#exceltitle").html("");
      $("#valueHidden").html("");
      jQuery.post("<?php echo base_url() ?>exca/search_board", data, function(response) {
 ...
 //console.log(datalvl2.sort());
        datalvl0.push({
          ...
          drilldown: {
			...
			name: "EXCA <b style'display:none'>" + data_hour[i] + "</b>",
            color: "#D32E36",
            categories: pr,
            level: 1,
            data: datalvl1
      ...
      chart = new Highcharts.Chart({
        ...
        subtitle: {
          text: 'Dashboard Exca On Duty ' + date
        },
        accessibility: {
          announceNewData: {
            enabled: true
                  ...
                  case 0:
                    ...
                    if (location == 0) {
                      ...
                      outputlabel = this.y + " Unit";
                        ...
                        //title = "Total Data di " + location + " : " + length_data;
						 title = "Total Data: " + length_data;
                ...
                switch (this.series.options.level) {
                  case 0:
                    if (location == 0) {
					  ...
					  title = "Total Unit " + data_company[0] + " : " + length_data;
                      ...
                      outputlabel = this.y + " Unit";
                        ...
                        title = "Total Unit " + data_company[0] + " di " + location + " : " + length_data;
    ...
    function createTable(response, table_loc_name) {
      ...
      $("#exceltitle").html("Total Unit Per Jam pada tanggal " + date + " " + table_loc_name);
      return false;
    }
  </script>