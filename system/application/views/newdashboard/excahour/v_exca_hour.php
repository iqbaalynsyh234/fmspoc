...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="col-md-12">
            <div class="panel" id="panel_form">
                <header class="panel-heading panel-heading-red">EXCA ON DUTY REPORT</header>
                ...
                <div class="panel-body" id="bar-parent10">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-5">
						 ...
						 <div class="col-md-2 col-sm-5">
							<select class="form-control select2" id="shift_hour" name="shift_hour">
								<option value="all" selected>-- All Hour --</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12" id="viewtable">
                            ...
                            <div id="isexport_xcel">
                                <div class="row">
                                    <div class="col-md">
                                        <!--<b id="exceltitle">Exca on Duty Report <span id="titlecontractor"></span> setiap Jam di <span id="titleshift"></span> tanggal <span id="titledate"></span></b>-->
                                    </div>
                                    <!-- <div class="col-md-6">
    ...
    <script type="text/javascript">
        ...
        function dtdatechange() {
            ...
            jQuery.post("<?php echo base_url() ?>exca/search", data, function(response) {
                ...
                if (response.error) {
                    ...
                    if (titlecompany == 0) {
                        ...
                        $("#titlecontractor").html(data[0]['radius_report_host_vehicle_company_name']);
                    ...
                    for (i = 0; i < response.total; i++) {
                        ...
                        html += `<tr>
                                        ...
                                        <td>` + data[i]['radius_report_host_vehicle_company_name'] + `</td>
										<td>` + data[i]['radius_report_host_vehicle_no'] + `</td>
										<td>` + data[i]['radius_report_guest_vehicle_no'] + `</td>
										<td>` + setdate(data[i]['radius_report_date']) + `</td>
                                        <td>` + data[i]['radius_report_hour'] + `</td>
										<td>` + data[i]['radius_report_start_time'] + `</td>
										<td>` + data[i]['radius_report_distance'] + `</td>
										<td>` + data[i]['radius_report_start_coordinate'] + `</td>
										<td>` + data[i]['radius_report_end_coordinate'] + `</td>
										<td>` + data[i]['radius_report_duration'] + `</td>
