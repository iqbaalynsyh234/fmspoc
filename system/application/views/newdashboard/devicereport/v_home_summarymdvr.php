    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="mdvr-report">MDVR REPORT</header>
...
$(document).ready(function() {
  ...
  function appendthevehiclelist(){
    ...
    if (privilegecode == 5 || privilegecode == 6) {
	 ...
	 function page(p) {
		...
		jQuery("#offset").val(p);
		jQuery("#loader2").show();
		jQuery.post("<?= base_url(); ?>devicereport/search_summarymdvr", jQuery("#frmsearch").serialize(),
			function(r) {
        console.log("response search_summarymdvr : ", r);
				if (r.error) {
					alert(r.message);
					jQuery("#loader2").hide();
					jQuery("#result").hide();
  ...
  function getVehicleByContractor() {
    ...
    $("#vehicle").html("");
    $.post("<?php echo base_url() ?>devicereport/vehicleByContractor", {companyid : data_company, valuemapsoption: 9999}, function(response){
