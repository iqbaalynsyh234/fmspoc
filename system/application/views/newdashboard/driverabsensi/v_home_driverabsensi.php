...
<script>
  ...
  function page(p) {
    ...
    jQuery("#loader2").show();
    jQuery.post("<?=base_url();?>driverabsensi/searchthis", jQuery("#frmsearch").serialize(),
      function(r) {
        if (r.error) {
          alert(r.message);
          jQuery("#loader2").hide();
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="driver-absensi">DRIVER ABSENSI REPORT</header>
          <div class="panel-body" id="bar-parent10">
            <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
                ...
                <div class="col-lg-4 col-md-3">
                  <select id="driver" name="driver" class="form-control select2">
                    ...
                    <?php
                          ...
                          <option value="<?php echo $datadriver[$i]['driver_id'] ?>"><?php echo $datadriver[$i]['driver_name'] ?></option>
													<?php }?>
                  </select>
                </div>
              ...
              <div class="form-group row" id="mn_vehicle">
                <label class="col-lg-3 col-md-3 control-label">Shift Type
                </label>
                <div class="col-lg-4 col-md-3">
                  <select id="shifttype" name="shifttype" class="form-control select2">
