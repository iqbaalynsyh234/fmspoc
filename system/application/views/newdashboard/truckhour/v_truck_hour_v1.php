...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="col-md-12">
            <div class="panel" id="panel_form">
                <header class="panel-heading panel-heading-red" id="truck_onduty">Truck On Duty</header>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-5">
                            <select id="viewdata" name="viewdata" class="form-control select2" onchange="viewchange()">
                                <option value="1">View by Graphic</option>
                                <option value="0">View by Table</option>
                            </select>
                        </div>
    ...
    <script type="text/javascript">
        ...
        //       $("#exceltitle").html("Data DT Operasional tanggal " + date);
        ...
        function dtdatechange() {
            ...
            $("#container_graphic").html("");
            $("#exceltitle").html("");
            jQuery.post("<?php echo base_url() ?>truck/searchv1", data, function(response) {
                console.log(response);
                var data = response.data;
                ...
                if (total > 0) {
                    ...
                    $("#totalan").html(`Total Unit Rata-rata ` + shiftname + ` : <b>` + totalavg + ` &nbsp; </b>`);
                    $("#exceltitle").html("Data DT Operasional tanggal " + date);
                    creatchart(response, charttotal, date);
                } else {
                    console.log(response);
                    alert("data empty");
                }
        ...
        function creatchart(response, charttotal, date) {
