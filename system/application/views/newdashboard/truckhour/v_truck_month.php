...
function page(p)
	{
		...
		jQuery.post("<?=base_url();?>truck/searchmonth", jQuery("#frmsearch").serialize(),
			function(r)
			{
				if (r.error) {
					alert(r.message);
					...
					<div class="col-md-12 col-sm-12">
                            <div class="panel" id="panel_form">
                              <div class="card-header">
								<center><font size="5px"><b>TRUCK ON DUTY (SUMMARY)</font> </b><br /><small><span id="periode_show"></span></small></center>
							  </div>
