    ...
    <div class="row">
      <div class="col-md-12" id="tablebranchoffice">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading" style="background-color: #221f1f"><font color="white">Master Data - PJA</font></header>
                ...
                <tbody>
                  <?php for($i=0;$i<count($data);$i++) { ?>
					<tr>
								...
								<td><small><?php echo $data[$i]->master_pja_id_sync;?></td>
								<td><small><?php echo $data[$i]->master_pja_name;?></td>
            					<td><small>
									<?php 
										if($data[$i]->master_pja_active == 1){
											echo "Yes";
										}else{
											echo "No";
										}
								...
								<td><small><?php echo $data[$i]->master_pja_type_id;?></td>
            					<td><small><?php echo $data[$i]->master_pja_type_name;?></td>
								<td><small><?php echo $data[$i]->master_pja_location_id;?></td>
            					<td><small><?php echo $data[$i]->master_pja_location_name;?></td>
								<td><small><?php echo $data[$i]->master_pja_location_lat;?></td>
            					<td><small><?php echo $data[$i]->master_pja_location_long;?></td>
					</tr>
                  <? } ?>
  					</tbody>
				</table>
