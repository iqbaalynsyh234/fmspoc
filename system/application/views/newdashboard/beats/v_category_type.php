    ...
    <div class="row">
      <div class="col-md-12" id="tablebranchoffice">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading" style="background-color: #221f1f"><font color="white">Master Data - Category Type</font></header>
                ...
                <tbody>
                  <?php for($i=0;$i<count($data);$i++) { ?>
					<tr>
								...
								<td><small><?php echo $data[$i]->master_categorytype_id_sync;?></td>
								<td><small><?php echo $data[$i]->master_categorytype_name;?></td>
								<td><small><?php echo $data[$i]->master_categorytype_desc;?></td>
            					<td><small>
									<?php 
										if($data[$i]->master_categorytype_active == 1){
											echo "Yes";
										}else{
											echo "No";
										}
								...
								<td><small>
									<?php 
										if($data[$i]->master_categorytype_closed == 1){
											echo "Yes";
										}else{
											echo "No";
										}
