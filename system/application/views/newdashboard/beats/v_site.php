    ...
    <div class="row">
      <div class="col-md-12" id="tablebranchoffice">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading" style="background-color: #221f1f"><font color="white">Master Data - Site</font></header>
                ...
                <tbody>
                  <?php for($i=0;$i<count($data);$i++) { ?>
					<tr>
								...
								<td><small><?php echo $data[$i]->master_site_id_sync;?></td>
								<td><small><?php echo $data[$i]->master_site_name;?></td>
            					<td><small><?php echo $data[$i]->master_site_shortname;?></td>
            					<td><small><?php echo $data[$i]->master_site_lat;?></td>
            					<td><small><?php echo $data[$i]->master_site_long;?></td>
								<td><small>
									<?php 
										if($data[$i]->master_site_active == 1){
											echo "Yes";
										}else{
											echo "No";
										}
