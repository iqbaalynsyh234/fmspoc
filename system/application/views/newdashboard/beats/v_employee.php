    ...
    <div class="row">
      <div class="col-md-12" id="tablebranchoffice">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading" style="background-color: #221f1f"><font color="white">Master Data - Employee</font></header>
                ...
                <tbody>
                  <?php for($i=0;$i<count($data);$i++) { ?>
					<tr>
								...
								<td><small><?php echo $data[$i]->karyawan_bc_id_sync;?></td>
								<td><small><?php echo $data[$i]->karyawan_bc_sid;?></td>
            					<td><small><?php echo $data[$i]->karyawan_bc_name;?></td>
            					<td><small><?php echo $data[$i]->karyawan_bc_position;?></td>
            					<td><small><?php echo $data[$i]->karyawan_bc_company_id;?></td>
								<td><small><?php echo $data[$i]->karyawan_bc_companycode;?></td>
								<td><small><?php echo $data[$i]->karyawan_bc_company;?></td>
