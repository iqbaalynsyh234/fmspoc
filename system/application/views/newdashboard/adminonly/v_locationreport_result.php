...
<div class="panel" id="panel_map" style="display:none">
	<header class="panel-heading" id="detail-trip">Detail Trip</header>
...
<div class="row">
  <div class="col-md-12 col-sm-12">
    <div class="panel">
      ...
      <header class="panel-heading" id="result-dev">RESULT - DEVELOPMENT</header>
      <div class="panel-body" id="bar-parent10">
        <div class="row">
          <?php if (count($data) == 0) {
							echo "<p>No Data</p>";
            ...
            <div class="col-md-12 col-sm-12">
              ...
              <div id="isexport_xcel">
                <table class="table table-striped custom-table table-hover" style="overflow-x:auto;">
                  <thead>
                    <tr>
