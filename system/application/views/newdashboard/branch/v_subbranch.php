...
<div class="page-content-wrapper" style="width: 100%;">
  <div class="page-content">
    ...
    <div class="row">
      <div class="col-md-12" id="tablesubbranchoffice">
        <div class="panel" id="panel_form">
          <header class="panel-heading" style="background-color:#221f1f;color:white;">Sub Branch Office</header>
    ...
    <div class="col-md-12" id="formaddbranchoffice" style="display: none;">
      <div class="panel" id="panel_form">
        <header class="panel-heading panel-heading-red">Add Sub Branch Office</header>
        <div class="panel-body" id="bar-parent10">
