    ...
    <div class="row">
      <div class="col-md-12" id="formaddbranchoffice">
        <div class="panel" id="panel_form">
          <header class="panel-heading" style="background-color:#221f1f;color:white;">Edit Branch Office</header>
          <div class="panel-body" id="bar-parent10">
            <form class="form-horizontal" name="frmedit" id="frmedit" onsubmit="javascript:return frmedit_onsubmit()">
              ...
              <input type="hidden" name="company_name_old" id="company_name_old" value="<?php echo $data->company_name;?>" />
