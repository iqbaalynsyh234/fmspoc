        				...
        				<div>
        					<ol>
                                ...
                                <span class="info-box-icon push-bottom" style="margin-top:4%;">
        										...
        										<li>
        											<h4 class="level-4 rectangle" style="color:white;">Person B</h4>
        										</li>
        										<li>
        											<h4 class="level-4 rectangle" style="color:white;">Person C</h4>
        										</li>
        										<li>
        											<h4 class="level-4 rectangle" style="color:white;">Person D</h4>
        										</li>
        									</ol>
        								</li>
