...
<script>
    ...
    function page(p) {
        ...
        jQuery("#loader2").show();
        jQuery.post("<?= base_url(); ?>ritasereport2/search", jQuery("#frmsearch").serialize(),
            function(r) {
                if (r.error) {
                    alert(r.message);
                    jQuery("#loader2").hide();
    ...
    function company_onchange() {
        ...
        if (data_company == 0) {
            ...
            var site = "<?= base_url() ?>ritasereport2/get_vehicle_by_company_with_numberorder/" + data_company;
            jQuery.ajax({
                url: site,
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="panel" id="panel_form">
                    <header class="panel-heading panel-heading-red" id="ritase-report">RITASE REPORT</header>
