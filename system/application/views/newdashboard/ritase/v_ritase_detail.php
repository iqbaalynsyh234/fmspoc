...
<script>
    ...
    function page(p) {
        ...
        jQuery("#loader2").show();
        jQuery("#result").hide();
        jQuery.post("<?= base_url(); ?>ritasedetail/search", jQuery("#frmsearch").serialize(),
            function(r) {
                console.log(r);
                if (r.error) {
                    alert(r.message);
    ...
    function company_onchange() {
        ...
        if (data_company == 0) {
            ...
            var site = "<?= base_url() ?>ritasedetail/get_vehicle_by_company_with_numberorder/" + data_company;
            jQuery.ajax({
                url: site,
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="panel" id="panel_form">
                    <header class="panel-heading" id="ritase-detail" >RITASE (DETAIL) REPORT</header>
