...
<script>
	...
	function frmsearch_onsubmit() {
		...
		// console.log(data);
		jQuery.post("<?= base_url(); ?>ritase/search_summary", jQuery("#frmsearch").serialize(),
			function(r) {
				if (r.error) {
					console.log(r);
					alert(r.message);
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="panel" id="panel_form">
					<header class="panel-heading panel-heading-red" id="ritase-summary">RITASE SUMMARY</header>
					<div class="panel-body" id="bar-parent10">
						<form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
							<div class="form-group row">
								...
								<!-- <div id="mn_date" > -->
								<div class="col-lg-2 col-md-2 mn_date" style="display:none">
								...
								<div class="col-lg-1 col-md-1 mn_date" style="display:none">
									s/d
								</div>
								<div class="col-lg-2 col-md-2 mn_date" style="display:none">
									<div class="input-group date form_date" data-date="" data-date-format="dd-mm-yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
