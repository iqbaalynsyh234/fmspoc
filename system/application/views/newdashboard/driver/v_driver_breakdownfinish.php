			   ...
			   <tr style="display:none;">
				 ...
				 <tr>
					<td colspan="2" align="center">
						<a onclick="javascript:save();" ><img src="<?=base_url();?>assets/bib/images/finishactive.png" alt="TOMBOL FINISH" width="100px" height="100px"></a>
						<br />
						<font style="font-size:10px;">Tekan tombol finish jika sudah selesai dan sebagai notifikasi ke Command Center</font>
				   </td>
