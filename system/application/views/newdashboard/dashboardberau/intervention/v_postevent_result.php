                ...
                // FILTER ALERT KHUSUS FATIGUE
                    ...
                    <?php
      				...
      				<td id="detaildatatd<?php echo $i?>">
								...
								<button type="button" class="btn btn-warning" onclick="modal_post_event_controlroom('<?php echo $content[$i]['alarm_report_vehicle_id'].','.$content[$i]['alarm_report_start_time'].','.$content[$i]['alarm_report_id'].','.$alarmtype; ?>');" title="Post Event">
