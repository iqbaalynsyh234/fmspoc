...
<script type="text/javascript">
  ...
  function modal_post_event_controlroom(id){
   $("#loadernya").show();
    ...
    $.post("<?php echo base_url() ?>dashboardberau/post_event_detail_controlroom", {alert_id : data[0], sdate : data[1], alarm_report_id : data[2], alarmtype : data[3]}, function(response){
    $("#loadernya").hide();
