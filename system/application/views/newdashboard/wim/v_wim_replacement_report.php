    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading-red" id="wim">WIM - REPLACEMENT REPORT</header>
...
<script>
	 function frmsearch_onsubmit() {
		jQuery("#loader2").show();
		jQuery.post("<?= base_url(); ?>wim/search_replacementreport", jQuery("#frmsearch").serialize(),
			function(r) {
        console.log("response search_replacementreport : ", r);
				if (r.error) {
					alert(r.message);
					jQuery("#loader2").hide();
					jQuery("#result").hide();
