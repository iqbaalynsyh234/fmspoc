    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading-red" id="data-wim">DATA WIM OTHER PORT</header>
...
<script>
    ...
    $("#table_3").DataTable( {
	 ...
	 function page(p) {
		...
		jQuery("#offset").val(p);
		jQuery("#loader2").show();
		jQuery.post("<?= base_url(); ?>wim/search_report_otherport", jQuery("#frmsearch").serialize(),
  ...
  function updateData(){
    jQuery("#loader2").show();
		jQuery.post("<?= base_url(); ?>wim/itwsotherport_update_data", jQuery("#frmsearch").serialize(),
			function(response) {
              ...
              for (i = 0; i < arr.length; i++) {
                ...
                // if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                  ...
                  b.addEventListener("click", function(e) {
                      ...
                      $("#loader2").show();
                        $.post("<?= base_url(); ?>wim/recallThisVehicleotherport", data2, function(response) {
                          $("#loader2").hide();
