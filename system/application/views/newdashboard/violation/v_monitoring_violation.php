          ...
          <div class="row">
            ...
            <div id="tableShowMuatan" style="width: 100%; height: 472px; display:none;">
                ...
                <div class="col-md-2">
                  <ul class="timeline">
                    <?php for ($i=30; $i > 25; $i--) {?>
                      ...
                      <li class="timeline-inverted">
                        <div class="" id="vehicleonkosongan<?php echo $i ?>">0</div>
                        <div class="" id="vehicleonmuatan<?php echo $i ?>">0</div>
                        <div class="timeline-panel"></div>
                      </li>
                    <?php } ?>
                  </ul>
                      ...
                      <li class="timeline-inverted">
                        ...
                        <?php
                          if ($i == 1) {?>
                            ...
                            <li class="timeline-inverted">
                              <span style="float:left; margin-left:3px; margin-top:-7px;">PORT 1</span>
                              <span style="float:left; margin-left:-44px; margin-top:33px;">PORT 2</span>
                              <div class=""  id="port_bib_kosongan">0</div>
                              <div class=""  id="port_bib_muatan">0</div>
                              <div class=""  id="port_bir_kosongan" style="margin-top:1%;">0</div>
                              <div class="" id="port_bir_muatan" style="margin-top:1%;">0</div>
                              <div class="timeline-panel"></div>
                            </li>
              ...
              <!-- <div class="row" style="margin-left:0%;">
                    <div class="col-md-3">
                       <button class="btn btn-success"  style="width: 100%; font-size: 16px; font-weight:bold;">
                         <span>
                           ROM B1 ROAD : <span id="total_romb1_road">0</span>
                         </span>
                       </button>
                    </div>
                    ...
                    <div class="col-md-3">
                       <button class="btn btn-success"  style="width: 100%; font-size: 16px; font-weight:bold;">
                         <span>
                           ROM B2 ROAD : <span id="total_romb2_road">0</span>
                         </span>
                       </button>
                    </div>
                    ...
                    <div class="col-md-3">
                       <button class="btn btn-success"  style="width: 100%; font-size: 16px; font-weight:bold;">
                         <span>
                           EST ROAD : <span id="total_est_road">0</span>
                         </span>
                       </button>
                    </div>
...
<script>
  ...
  function listVehicleOnKm(idkm){
    ...
    if (idkm == 1) {
			...
			kmonsearch = ["KM 29", "KM 29.5", "KM 30", "KM 30.5"];
		}
      ...
      if (dataKosonganfix.length == 0) {
        ...
        $("#modalKmListQuickCountTitle").html("KM " + idkm);
  ...
  function listVehicleOnKm_OLD(idkm){
    console.log("idkm : ", idkm);
    var contractor         = $("#contractor").val();
    var lasttime_violation = $("#lasttime_violation").val();
    $.post("<?php echo base_url() ?>violation/getlistinkm2", {idkm : idkm, contractor : contractor, lasttime_violation:lasttime_violation}, function(response){
