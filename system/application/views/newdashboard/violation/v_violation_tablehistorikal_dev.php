        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-2">
                <img id="violation_pulse" src="<?php echo base_url();?>assets/bib/images/violation_pulse.gif" width="40px" height="auto" style="cursor:pointer;" onclick="showModal();"/>
...
<!-- assets/dashboard/assest/js/myjs -->
<div id="modal_violation_modal" class="modalviolation">
  <div class="modal-content-violation">
    <div class="row">
      <div class="col-md-10">
        <p class="modalTitleforAll" id="modal_violation_title">
        </p>
        <div id="last_check_violation" style="font-size:12px; color:black"></div>
      </div>
      <div class="col-md-2">
        <div class="closethismodal_violation btn btn-danger btn-sm">X</div>
      </div>
    </div>
    <div class="row" id="modal_violation_row">
      <div class="col-md-12">
        <p style="color: black; font-style: bold;">
          Violation Frequency
            <img id="violation_pulse" src="<?php echo base_url();?>assets/bib/images/violation_pulse.gif" width="40px" height="auto" style="cursor:pointer;" onclick="showModal();"/>
        </p>
        <div id="modalStateContentTable">
...
<script>
  ...
  var showmodaltype, interval_popup_violation;
  interval_popup_violation          = setInterval(showModal, 10000);
  function showModal(){
    console.log("showmodal masuk");
    showmodaltype = 1;
    $("#modal_violation_title").html("Violation Frequency");
    $("#contractorinlocation").html("contractor");
    $("#last_check_violation").html('<?php echo date("Y-m-d H:i:s") ?>');
    modalViolationPulse('modal_violation_modal');
  }

  var intervalkmlist, current_totalov;
  intervalkmlist          = setInterval(data_list_first, 20000);
  var simultantype        = 0;
