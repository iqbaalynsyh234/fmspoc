      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-head" style="text-align:center; font-size:large;">
            <header>
              <b>
                REAL-TIME VIOLATION DEVELOPMENT
              </b>
            </header>
            <div class="tools">
                      ...
                      <li class="timeline-inverted">
                        ...
                        <?php
                          if ($i == 1) {?>
                            ...
                            <li class="timeline-inverted">
                              <span style="float:left; margin-left:26px; margin-top:-7px;">BIB</span>
                              <span style="float:left; margin-left:-21px; margin-top:33px;">BIR</span>
...
<script>
  ...
  var top_limit    = 16;
  var intervalkmlist;
  intervalkmlist   = setInterval(showTableMuatan, 20000);
  ...
  function showTableMuatan(){
    ...
    $.post("<?php echo base_url() ?>violation/km_quickcount_new2", datanya, function(response){
      jQuery("#loader2").hide();
      $("#tableShowMuatan").show();
          $("#simultantype").val(1);
          $("#lasttime_violation").val(response.lasttime);
            if (response.violationmix.length > 0) {
              console.log("response km_quickcount_new2 : ", response);
              ...
              current_violationmix  =  response.violationmix;
               ...
               // SIMPANG BAYAH MUATAN PORT BIB & BIR
                ...
                for (var i = 0; i < sizemuatan; i++) {
                  ...
                  // intervalkmlist = setInterval(km_quickcount_simultan, 20000);
            }else {
