    ...
    <div class="row">
      <div class="col-md-12 col-sm-12" id="reportfilter">
        ...
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="security-evidence">Security Evidence</header>
...
$("#loadernya").hide();
  ...
  function getdetailinfo(id){
    ...
    $.post("<?php echo base_url() ?>securityevidence/getinfodetail_new", {alert_id : data[0], sdate : data[1]}, function(response){
	  $("#loadernya").hide();
