    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading-red">DATA WIM OTHER PORT - DEVELOPMENT</header>
            ...
            <div id="formsearch_new">
              <table class="table table-striped" style="width:100%;">
                  ...
                  <td>
                    <div class="col-lg-10 col-md-10">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" name="itws_driver" id="itws_driver" class="form-control" hidden>
                        <input type="text" name="itws_driver_search" id="itws_driver_search" class="form-control" readonly>
                ...
                <tr>
                  ...
                  <td>
                    <div class="col-lg-10 col-md-10">
                      <div class="autocompleteclient" style="width:160px;">
                      <div class="input-group mb-3">
                          <input type="text" name="itws_client" id="itws_client" class="form-control" readonly>
                        <div class="input-group-append">
                  ...
                  <td>
                    <div class="col-lg-12 col-md-12">
                      ...
                      <div class="input-group mb-3">
                          <input type="text" name="itws_material" id="itws_material" class="form-control"readonly>
                        <div class="input-group-append">
                ...
                <tr>
                  ...
                  <td>
                    <div class="col-lg-12 col-md-12">
                      <input type="number" name="itws_gross" id="itws_gross" class="form-control" readonly>
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="col-lg-12 col-md-12">
                      <input type="number" name="itws_tare" id="itws_tare" class="form-control" readonly>
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="col-lg-12 col-md-12">
                      <input type="number" name="itws_netto" id="itws_netto" class="form-control" readonly>
                    </div>
                  </td>

                  <td>
                    <div class="col-lg-12 col-md-12">
                      <input type="number" name="itws_gross_manual" id="itws_gross_manual" placeholder="Gross Other Port" class="form-control">
                    </div>
                  </td>
                </tr>
...
<script>
    ...
    $("#table_3").DataTable( {
	 ...
	 function page(p) {
		...
		jQuery("#offset").val(p);
		jQuery("#loader2").show();
		jQuery.post("<?= base_url(); ?>development/search_report_otherport", jQuery("#frmsearch").serialize(),
    // jQuery.post("<?= base_url(); ?>development/search_report_operator", jQuery("#frmsearch").serialize(),
			function(r) {
  ...
  function updateData(){
    jQuery("#loader2").show();
		jQuery.post("<?= base_url(); ?>development/itwsotherport_update_data", jQuery("#frmsearch").serialize(),
			function(response) {
	...
	function company_onchange() {
		...
		if (data_company == 0) {
			...
			var site = "<?= base_url() ?>development/get_vehicle_by_company_with_numberorder/" + data_company;
			jQuery.ajax({
				url: site,
  ...
  var currentFocus;
    ...
    inp.addEventListener("input", function(e) {
        ...
        if (keyword_vehicle.length >= 3) {
          ...
          $("#loader2").show();
          $.post("<?= base_url(); ?>development/getVehicleByInput", data,
            function(r) {
              $("#loader2").hide();
              ...
              for (i = 0; i < arr.length; i++) {
                ...
                // if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                  ...
                  b.addEventListener("click", function(e) {
                      ...
                      $("#loader2").show();
                        $.post("<?= base_url(); ?>development/recallThisVehicleotherport", data2, function(response) {
                          $("#loader2").hide();
                          ...
                          var code = response.code;
                            if (code == 200) {
                                ...
                                // CHANGE ROM SELECT
                                $('#itws_rom').val(response.data_forprocess.integrationwim_last_rom);
                                $('#itws_gross').val(response.data_forprocess.integrationwim_gross);
                                $('#itws_tare').val(response.data_forprocess.integrationwim_tare);
                                $('#itws_netto').val(response.data_forprocess.integrationwim_netto);
                                ...
                                $("#itws_driver").val(response.data_forprocess.integrationwim_driver_iditws+'|'+response.data_forprocess.integrationwim_driver_nameitws);
                                $("#itws_driver_search").val(response.data_forprocess.integrationwim_driver_nameitws);
  ...
  inp.addEventListener("input", function(e) {
      ...
      $("#loader2").show();
      $.post("<?= base_url(); ?>development/getDriverItws", data,
  			function(r) {
          $("#loader2").hide();
          ...
          for (i = 0; i < arr.length; i++) {
            ...
            // if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
              ...
              b.addEventListener("click", function(e) {
                  ...
                  $("#loader2").show();
                    $.post("<?= base_url(); ?>development/getDriverItwsValue", data4, function(response) {
                      $("#loader2").hide();
