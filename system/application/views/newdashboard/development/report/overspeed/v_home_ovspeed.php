<script>
  ...
  function page(p) {
    ...
    jQuery("#result").hide();
    jQuery("#loader2").show();
    jQuery.post("<?=base_url();?>development/search_overspeedreport", jQuery("#frmsearch").serialize(),
    // jQuery.post("<?=base_url();?>development/search_overspeedreport_localmethod", jQuery("#frmsearch").serialize(),
      ...
      function(r) {
        if (r.error) {
          ...
          console.log("response search_overspeedreport : ", r);
          // $("#temp_code").val(r.code_temp);
          jQuery("#loader2").hide();
          jQuery("#result").show();
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading-red">OVERSPEED REPORT - DEVELOPMENT</header>
          <div class="panel-body" id="bar-parent10">
            <input type="text" id="temp_code" hidden>
                ...
                <div class="col-lg-2 col-md-2">
                  <div id="showhideselectedkm">
                        <select class="form-control select2" multiple="multiple" name="kmselected_select[]" id="kmselected_select">
                          <option value="all">--All KM BIB & TIA</option>
                          <option value="allkm">--All KM BIB</option>
                          <option value="alltia">--All KM TIA</option>
                          <?php
                            for ($j=0; $j < sizeof($datastreetfix); $j++) {?>
                              <option value="<?php echo $datastreetfix[$j]['street_name'] ?>"> <?php echo $datastreetfix[$j]['street_name']; ?></option>
                            <?php }
                           ?>
                        </select>
                    </div>
                    ...
                    <div id="showhiderangekmstart" style="display:none;">
                        <select class="form-control select2" name="kmstart" id="kmstart" onchange="setkmend()">
                          ...
                          <option value="alltia">--All KM TIA</option>
                          <?php
                            for ($i=0; $i < sizeof($datastreetfix); $i++) {?>
                              <option value="<?php echo $datastreetfix[$i]['street_name'] ?>"> <?php echo $datastreetfix[$i]['street_name']; ?></option>
                            <?php }
                           ?>
                        </select>
                      </div>
...
<script type="text/javascript">
  function setkmend(){
    ...
    jQuery("#loader2").show();
      $.post("<?php echo base_url() ?>development/create_half_loop", {kmstart : kmstart}, function(response){
        jQuery("#loader2").hide();
