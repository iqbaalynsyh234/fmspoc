...
<div class="row">
	<div class="col-md-12 col-sm-12">
		<div class="panel">
			<header class="panel-heading panel-heading-red">RESULT - DEVELOPMENT</header>
				<div class="panel-body" id="bar-parent10">
					<div class="row">
            <div class="col-md-12">
              <?php
                echo "<p>Jarak antara <b>".$dataradiustext['unit_1']."</b> (".$dataradiustext['gps_time_1']." : ".$dataradiustext['coord_1'].") dengan <b>".$dataradiustext['unit_2']."</b> (".$dataradiustext['gps_time_2']." : ".$dataradiustext['coord_2'].") = ".$dataradiustext['meter']." Mtr</p>";
               ?>
              <!-- <p>Jarak antara <b>" + r.unit_1 + "</b> ("+r.gps_time_1+" : "+r.coord_1+") dengan <b>" + r.unit_2 + "</b> ("+r.gps_time_2+" : "+r.coord_2+") = <b>" + r.meter + " Mtr</b>")</p> -->
...
window.clearInterval(foranimate);
       ...
       var dataradius              = '<?php echo $dataradius; ?>';
       var objdataradius           = JSON.parse(dataradius);
       ...
       console.log("objdataradius : ", objdataradius);
       ...
       coords = [];
  		  for (var x = (obj.length-1); x >= 0; x--) {
					...
					var longitude_fix = "";
					// console.log("Format : " + (x+1) , longitude_format.length);
						if (longitude_format.length < 4) {
       ...
       // Add multiple markers to map
        ...
        var icon2 = {
         ...
         var position  = new google.maps.LatLng(parseFloat(coords[0].lat), parseFloat(coords[0].lng));
         var position2 = new google.maps.LatLng(parseFloat(coords[1].lat), parseFloat(coords[1].lng));
