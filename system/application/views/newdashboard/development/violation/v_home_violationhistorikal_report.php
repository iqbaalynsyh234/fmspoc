    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="violation-his">Violation Historikal Table Report - DEVELOPMENT</header>
          <div class="panel-body" id="bar-parent10">
            <form class="form-horizontal form" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
              ...
              <div class="form-group row" id="mn_vehicle">
								...
								<div class="col-lg-4 col-md-3">
                  <select id="violationmasterselect" name="violationmasterselect" class="form-control select2">
...
<script>
	 function page(p) {
		...
		jQuery("#loader2").show();
    jQuery("#result").hide();
		jQuery.post("<?= base_url(); ?>development/search_violationtablehistorikal", jQuery("#frmsearch").serialize(),
			function(r) {
        console.log("response search_violationtablehistorikal : ", r);
				if (r.error) {
					alert(r.message);
					jQuery("#loader2").hide();
					jQuery("#result").hide();
