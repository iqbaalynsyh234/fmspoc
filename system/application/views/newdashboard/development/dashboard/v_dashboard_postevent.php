    ...
    <div class="row">
      <div class="col-md-12 col-sm-12" id="reportfilter">
        ...
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="security-evidence">Dashboard Post Event - DEVELOPMENT</header>
...
<div id="modalposteventsubmit" style="display: none;">
   <!-- style="display: none;" -->
  <div class="row">
    <div class="col-md-12">
...
<script type="text/javascript">
  ...
  function frmsearch_onsubmit(){
    ...
    $("#loadernya").show();
    $.post("<?php echo base_url() ?>development/searchreport", jQuery("#frmsearch").serialize(), function(response){
      if (response.error) {
  ...
  function modal_post_event(id){
   $("#loadernya").show();
    ...
    $.post("<?php echo base_url() ?>development/post_event_detail", {alert_id : data[0], sdate : data[1], alarm_report_id : data[2], alarmtype : data[3]}, function(response){
    $("#loadernya").hide();
