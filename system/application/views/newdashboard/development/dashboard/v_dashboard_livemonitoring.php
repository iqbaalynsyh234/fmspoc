        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-3" id="showSiteOption">
                <select class="form-control select2" name="site_option" id="site_option">
                  <option value="0">--Site Option 1</option>
                  <option value="1">--Site Option 2</option>
                  <option value="2">--Site Option 3</option>
                </select>
              </div>
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="col-md-12" id="realtimealertshowhide" style="display:none;">
                 <!-- style="display:none;" -->
                <div class="panel" id="panel_form" style="width:140%;">
                  <header class="panel-heading" style="background-color: #221f1f; color:white;">
                    Realtime Alert
                    Show :
...
<script>
  ...
  // TOOGEL BUTTON BIB MAP
    ...
    toggleButton.textContent = "Drone Maps";
...
var intervalalert = setInterval(dataalert, 100000);
var lasttimealert = 0;
var limitalert    = 10;
...
function updateinfowindow(nopol){
  var deviceid = nopol;
    if (deviceid == 0) {
      ...
      var data = {key : deviceid};
      jQuery("#loader2").show();
      $.post("<?php echo base_url() ?>development/forsearchvehicle", data, function(response){
        jQuery("#loader2").hide();
