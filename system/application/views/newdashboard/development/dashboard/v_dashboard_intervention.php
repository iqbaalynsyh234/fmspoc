...
<script>
  ...
  intervalkmlist          = setInterval(data_list_first, 5000);
  var simultantype        = 0;
  ...
  function data_list_first(){
    ...
    jQuery("#loader2").show();
    $.post("<?php echo base_url() ?>violation/intervention_postevent", data, function(response){
      jQuery("#loader2").hide();
      ...
      if (response.violationmix.length > 0) {
          ...
          for (var i = 0; i < violationmix.length; i++) {
            var violation = violationmix[i].violation;
              ...
              var intervby = violationmix[i].alarm_report_intervensi_by_name;
              if (intervby == "" || intervby == null) {
                htmltable += '<td style="background-color:orange;color:white;">Belum Diintervensi</td>';
              }else {
                htmltable += '<td style="background-color:green;color:white;">'+violationmix[i].alarm_report_intervensi_by_name+'</td>';
              }

              var intervnote = violationmix[i].alarm_report_intervensi_note;
              if (intervnote == "" || intervnote == null) {
                htmltable += '<td style="background-color:orange;color:white;">Null</td>';
              }else {
                htmltable += '<td style="background-color:green;color:white;">'+violationmix[i].alarm_report_intervensi_note+'</td>';
              }

              var trueorfalse = violationmix[i].alarm_report_true_false;
              if (trueorfalse == 1) {
                htmltable += '<td style="background-color:green;color:white;">True Alarm</td>';
              }else {
                htmltable += '<td style="background-color:orange;color:white;">False Alarm</td>';
              }

              if (intervby == "" || intervby == null) {
                htmltable += '<td style="background-color:orange;color:white;">Belum Diintervensi</td>';
              }else {
                htmltable += '<td style="background-color:green;color:white;">Sudah Diintervensi</td>';
              }
