  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card" id="cardShowMap">
        <div class="card-body">
          <div class="row">
            <div id="tableShowMuatan" style="width: 100%; height: 750px;">
              <!-- display:none; -->
              ...
              <div class="row" style="margin-top:-3%; margin-left: -5%; height: 730px; overflow-y:hidden; overflow-x:auto;">
                <div class="col-md-2">
                  <ul class="timeline">
                    <?php for ($j=30; $j > 24; $j--) {?>
                      <?php
                      for ($k=0; $k < sizeof($street_matic); $k++) {
                        $street_group         = $street_matic[$k]['street_group'];
                        $street_group_nospace = str_replace("KM ", "", $street_group);
                          if ($street_group == "KM ".$j) {
                            $street_is_romroad = $street_matic[$k]['street_is_romroad'];
                              if ($street_is_romroad == 1) {?>
                                <li class="timeline-inverted">
                                  <div class="timeline-badge btn btn-primary btn-lg" id="labelvehicleonmuatan<?php echo $street_group_nospace ?>" onclick="listVehicleOnKm('<?php echo $j; ?>')">KM <?php echo $j; ?></div>
                                  <div class="timeline-panel"></div>
                                </li>
                                <li class="timeline-inverted">
                                  <div class="timeline-badge4 btn btn-success btn-md btn-circle" id="vehicleonkosongan<?php echo $street_group_nospace; ?>">50</div>
                                  <div class="timeline-badge5 btn btn-success btn-md btn-circle" id="vehicleonmuatan<?php echo $street_group_nospace; ?>">50</div>
                                  <div class="timeline-panel"></div> <br>
                                </li>
                                <li class="timeline-inverted">
                                  <?php
                                    $totalgroup = $street_matic[$k]['jumlah_total'];
                                   ?>
                                   <?php
                                    if ($totalgroup > 0) {
                                      for ($l=0; $l < $totalgroup; $l++) {
                                        $titlebox = explode(" ", $street_matic[$k]['data_group'][$l]['street_name']);
                                        $titlefix = explode(",", $titlebox[2]);
                                        ?>
                                     <?php
                                      if ($totalgroup == 1) {?>
                                        <span class="styletitlekmif1"><?php echo $titlefix[0]; ?></span>
                                        <div class="timeline-badge4 btn btn-success btn-md btn-circle" id="vehicleonkosongan<?php echo $street_group_nospace .'_'. $titlefix[0]; ?>">10</div>
                                        <div class="timeline-badge5 btn btn-success btn-md btn-circle" id="vehicleonmuatan<?php echo $street_group_nospace .'_'. $titlefix[0]; ?>">12</div>
                                      <?php }elseif ($totalgroup == 2) {?>
                                        <span class="styletitlekmif2"><?php echo $titlefix[0]; ?></span>
                                        <div class="timeline-badge8 btn btn-success btn-md btn-circle" id="vehicleonkosongan<?php echo $street_group_nospace .'_'. $titlefix[0]; ?>">20</div>
                                        <div class="timeline-badge9 btn btn-success btn-md btn-circle" id="vehicleonmuatan<?php echo $street_group_nospace .'_'. $titlefix[0]; ?>">22</div>
                                        <div class="timeline-badge10 btn btn-success btn-md btn-circle" id="vehicleonkosongan<?php echo $street_group_nospace .'_'. $titlefix[0]; ?>">30</div>
                                        <div class="timeline-badge11 btn btn-success btn-md btn-circle" id="vehicleonmuatan<?php echo $street_group_nospace .'_'. $titlefix[0]; ?>">25</div>
                                      <?php }?>
                                      <div class="timeline-panel"></div>
                                   <?php }?>
                                   <?php } ?>
                              ...
                              <?php }else {?>
                                ...
                                <li class="timeline-inverted">
                                  <div class="timeline-badge2 btn btn-success btn-md btn-circle" id="vehicleonkosongan<?php echo $j ?>"></div>
                                  <div class="timeline-badge3 btn btn-success btn-md btn-circle" id="vehicleonmuatan<?php echo $j ?>"></div>
                                  <div class="timeline-panel"></div>
                                </li>
                              <?php }
                          }
                            ...
                            $street_is_romroad = $street_matic[$k]['street_is_romroad'];
                              ...
                              <?php }else {?>
                                <li class="timeline-inverted">
                                  <?php
                                    if ($j == 1) {?>
                                      <div class="timeline-badge btn btn-primary btn-lg" id="labelvehicleonmuatan<?php echo $j ?>" onclick="listVehicleOnKm('<?php echo $j; ?>')">
                                        <p style="margin-left: -30%; margin-top: -30%; font-weight: bold;">
                                          KM 1
                                        </p>
                                      </div>
                                    <?php }else {?>
                                      <div class="timeline-badge btn btn-primary btn-lg" id="labelvehicleonmuatan<?php echo $j ?>" onclick="listVehicleOnKm('<?php echo $j; ?>')">KM <?php echo $j; ?></div>
                                    <?php }?>
                                  <div class="timeline-panel"></div>
                                </li>
                                <?php
                                  if ($j == 1) {?>
                                    <li class="timeline-inverted">
                                      ...
                                      <div class="timeline-badge4 btn btn-success btn-md btn-circle"  id="port_bib_kosongan"></div>
                                      <div class="timeline-badge6 btn btn-success btn-md btn-circle"  id="port_bib_muatan"></div>
                                      <div class="timeline-badge5 btn btn-success btn-md btn-circle"  id="port_bir_kosongan" style="margin-top:1%;"></div>
                                      <div class="timeline-badge7 btn btn-success btn-md btn-circle" id="port_bir_muatan" style="margin-top:1%;"></div>
                                      <div class="timeline-panel"></div>
                                    </li>
