                  ...
                  <ul class="timeline">
                    <?php for ($i=30; $i > 25; $i--) {?>
                      <li class="timeline-inverted">
                        <div class="" id="labelvehicleonmuatan<?php echo $i ?>" onclick="listVehicleOnKm('<?php echo $i; ?>')">
                          <p  style="margin-left: -5%; margin-top: -30%; font-weight: bold;">
                            KM <?php echo $i; ?>
                            <span class="badge headerBadgeColor1" id="badgekm<?php echo $i ?>" style="display:none;">!</span>
                          </p>
                        </div>
                        ...
                        <?php
                          if ($i == 1) {?>
                            <div id="labelvehicleonmuatan<?php echo $i ?>" onclick="listVehicleOnKm('<?php echo $i; ?>')">
                              <p style="margin-left: -5%; margin-top: -30%; font-weight: bold;">
                                KM 1
                                <span class="badge headerBadgeColor1" id="badgeportbib" style="display:none;">!</span>
                              </p>
                            </div>
                          <?php }else {?>
                            <div class="" id="labelvehicleonmuatan<?php echo $i ?>" onclick="listVehicleOnKm('<?php echo $i; ?>')">
...
<script>
  ...
  function km_quickcount_simultan(){
    ...
    $.post("<?php echo base_url() ?>development/km_quickcount_new", {companyid : companyid}, function(response){
      jQuery("#loader2").hide();
      ...
      var dataDelayMuatan         = response.dataDelayMuatan;
      var arraydatadelaymuatan    = Object.keys(dataDelayMuatan).map((key) => [String(key), dataDelayMuatan[key]]);

      var dataDelayMuatan2        = response.dataDelayMuatan2;
      var arraydatadelaymuatan2   = Object.keys(dataDelayMuatan2).map((key) => [String(key), dataDelayMuatan2[key]]);

      var dataDelayKosongan       = response.dataDelayKosongan;
      var arraydatadelaykosongan  = Object.keys(dataDelayKosongan).map((key) => [String(key), dataDelayKosongan[key]]);

      var dataDelayKosongan2      = response.dataDelayKosongan2;
      var arraydatadelaykosongan2 = Object.keys(dataDelayKosongan2).map((key) => [String(key), dataDelayKosongan2[key]]);
      ...
      var sizedelaymuatan    = arraydatadelaymuatan.length;
      var sizedelaykosongan  = arraydatadelaykosongan.length;
      var sizedelaymuatan2   = arraydatadelaymuatan2.length;
      var sizedelaykosongan2 = arraydatadelaykosongan2.length;
      ...
      var totalMuatandelay        = 0;
      var totalKosongandelay      = 0;
      var totalMuatan2delay       = 0;
      var totalKosongan2delay     = 0;
      var portbibkosongandelay    = 0;
      var portbirkosongandelay    = 0;
      var portbibmuatandelay      = 0;
      var portbirmuatandelay      = 0;
      ...
      // BADGE IN SIMPANG BAYAH / KM 1 START
      for (var i = 0; i < sizedelaykosongan2; i++) {
        var jumlahfix      = arraydatadelaykosongan2[i][1]; //arraydatamuatan[i][1]; //30+i; //arraydatamuatan[i][1];
        totalKosongan2delay += jumlahfix;
      }
      if (totalKosongan2delay > 0) {
        $("#badgeportbib").show();
      }else {
        $("#badgeportbib").hide();
      }
      // BADGE IN SIMPANG BAYAH / KM 1 END

      // BADGE IN KM 2 - 30 KOSONGAN START
      for (var i = 0; i < sizedelaykosongan; i++) {
        var jumlahfix      = arraydatadelaykosongan[i][1]; //arraydatamuatan[i][1]; //30+i; //arraydatamuatan[i][1];
          if (jumlahfix > 0) {
            $("#badgekm"+i).show();
          }else {
            $("#badgekm"+i).hide();
      ...
      // BADGE IN SIMPANG BAYAH / KM 1 MUATAN END
      for (var i = 0; i < sizedelaymuatan2; i++) {
        var jumlahfix = arraydatadelaymuatan2[i][1]; //arraydatamuatan[i][1]; //30+i; //arraydatamuatan[i][1];
        totalMuatan2delay += jumlahfix;
      }
      if (totalMuatan2delay > 0) {
        $("#badgeportbib").show();
      }else {
        $("#badgeportbib").hide();
      }
      ...
      // BADGE IN KM 2 - 30 KOSONGAN START
      for (var i = 0; i < sizedelaymuatan; i++) {
        var jumlahfix      = arraydatadelaymuatan[i][1]; //arraydatamuatan[i][1]; //30+i; //arraydatamuatan[i][1];
          if (jumlahfix > 0) {
            $("#badgekm"+i).show();
          }else {
            $("#badgekm"+i).hide();
      ...
      if (dataKosonganfix.length == 0) {
        ...
        for (var i = 0; i < dataKosonganfix.length; i++) {
          ...
          var lastenginefix;
            ...
            var autolaststatus = dataKosonganfix[i].auto_last_status;
              if (autolaststatus == "K") {
                htmlkosongan += '<tr style="background-color: yellow;">';
              }else if (autolaststatus == "M") {
                htmlkosongan += '<tr style="background-color: red;">';
              }else {
                htmlkosongan += '<tr style="background-color: white;">';
              }
      ...
      if (dataMuatanfix.length == 0) {
        ...
        for (var i = 0; i < dataMuatanfix.length; i++) {
          ...
          var speedkmfix = "";
            ...
            var autolaststatus = dataMuatanfix[i].auto_last_status;
              if (autolaststatus == "K") {
                htmlmuatan += '<tr style="background-color: yellow;">';
              }else if (autolaststatus == "M") {
                htmlmuatan += '<tr style="background-color: red;">';
              }else {
                htmlmuatan += '<tr style="background-color: white;">';
              }
