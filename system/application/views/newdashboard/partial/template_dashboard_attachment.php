...
<head>
  ...
  <meta name="Abditrack" content="FMS" />
  <meta name="Abditrack" content="Abditrack" />
  <title>Attachment</title>
  <!-- google font -->
  <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" rel="stylesheet" type="text/css" />
  <!-- icons -->
  <link href="https://182.283.236.245/assets/dashboard/assets/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
  <!--bootstrap -->
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
  <link href="https://182.283.236.245/assets/dashboard/assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />

  <!-- timeline -->
	<!-- <link rel="stylesheet" href="https://fmspoc.abditrack.com/assets/dashboard/assets/css/pages/timeline.css"> -->

  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/summernote/summernote.css" rel="stylesheet">
  <!-- morris chart -->
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
  <!-- Material Design Lite CSS -->
  <link rel="stylesheet" href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/material/material.min.css">
  <link rel="stylesheet" href="https://fmspoc.abditrack.com/assets/dashboard/assets/css/material_style.css">
  <!-- animation -->
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/css/pages/animate_page.css" rel="stylesheet">
  <link rel="stylesheet" href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/jquery-toast/dist/jquery.toast.min.css">

  <!-- inbox style -->
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/css/pages/inbox.min.css" rel="stylesheet" type="text/css" />
  <!-- Template Styles -->
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/css/plugins.min.css" rel="stylesheet" type="text/css" />
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/css/style.css" rel="stylesheet" type="text/css" />
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/css/mystyle.css" rel="stylesheet" type="text/css" />
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/css/responsive.css" rel="stylesheet" type="text/css" />
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/css/theme-color.css" rel="stylesheet" type="text/css" />
  <!-- Owl Carousel Assets -->
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/owl-carousel/owl.carousel.css" rel="stylesheet">
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/owl-carousel/owl.theme.css" rel="stylesheet">

  <!-- for form -->
  <!--select2-->
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/select2/css/select2.css" rel="stylesheet" type="text/css" />
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
  <link href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">

  <!-- Date Time item CSS -->
  <link rel="stylesheet" href="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/material-datetimepicker/bootstrap-material-datetimepicker.css" />
  <!-- end for form -->

	<!-- favicon -->
  <!-- <link rel="shortcut icon" href="https://fmspoc.abditrack.com/assets/images/favicon_lacakmobil.ico" /> -->
  <link rel="shortcut icon" href="https://fmspoc.abditrack.com/assets/abditrack/images/logo_icon_abditek.ico" />
</head>
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-red white-sidebar-color logo-white page-footer-fixed">
  <div class="page-wrapper">
    ...
    <div class="page-footer">
      <div class="page-footer-inner"> 2023 &copy;
		...
		<!-- <a href="https://www.goldenenergymines.com/" target="_blank" class="makerCss">PT. Borneo Indobara </a> -->
    <a href="https://abditek.co.id/" target="_blank" class="makerCss">Abditrack </a>
      </div>
        ...
        <div class="col-sm-12">
          <div class="card card-topline-green">
            ...
            <div class="card-body">
              ...
              <a href="https://api.whatsapp.com/send?phone=+628558208484&text=Halo.%20Ada%20yang%20ingin%20saya%20tanyakan." class="btn btn-success btn-circle" style="margin-bottom:2%; text-transform: capitalize;" target="_blank">
  ...
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/jquery/jquery.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/popper/popper.min.js" ></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
  <!-- <script src="https://fmspoc.abditrack.com/assets/js/pages/timeline/timeline.js"></script> -->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/jquery-blockui/jquery.blockui.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/moment/moment.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/counterup/jquery.waypoints.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/counterup/jquery.counterup.min.js"></script>
  <!-- owl carousel -->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/owl-carousel/owl.carousel.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/owl-carousel/owl_data.js"></script>
  <!-- Common js-->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/app.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/myjs.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/layout.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/theme-color.js"></script>
  <!-- Material -->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/material/material.min.js"></script>
  <!-- animation -->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/ui/animations.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/jquery-toast/dist/jquery.toast.min.js" ></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/jquery-toast/dist/toast.js" ></script>
  <!-- sparkline -->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/sparkline/jquery.sparkline.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/sparkline/sparkline-data.js"></script>
  <!-- summernote -->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/summernote/summernote.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/summernote/summernote-data.js"></script>

  <!-- timeline -->
  <!-- <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/timeline/timeline.js"></script> -->


  <!-- echart -->
  <!--<script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/echarts/echarts.js" ></script>
    <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/chart/echart/echart-data.js" ></script>-->

  <!--Chart JS-->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/chart-js/Chart.bundle.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/chart-js/utils.js"></script>
  <!--<script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/chart/chartjs/chartjs-data.js" ></script>-->

  <!-- data tables -->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/datatables/jquery.dataTables.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/table/table_data.js"></script>

  <!-- for form -->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker-init.js"></script>
  <!--select2-->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/select2/js/select2.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/select2/select2-init.js"></script>
  <!-- floating select -->
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/js/pages/material_select/getmdl-select.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/material-datetimepicker/moment-with-locales.min.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/material-datetimepicker/bootstrap-material-datetimepicker.js"></script>
  <script src="https://fmspoc.abditrack.com/assets/dashboard/assets/plugins/material-datetimepicker/datetimepicker.js"></script>
