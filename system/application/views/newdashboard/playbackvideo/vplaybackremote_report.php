...
function page(p)
	{
		...
		jQuery("#result").html();
		jQuery("#loader2").show();
		jQuery.post("<?=base_url();?>playbackrmtv/search", jQuery("#frmsearch").serialize(),
			function(r)
			{
				if (r.error) {
					alert(r.message);
                    ...
                    <div class="row">
						<div class="col-md-12 col-sm-12">
                            <div class="panel" id="panel_form">
                                <header class="panel-heading panel-heading-red">PLAYBACK REMOTE VIDEO</header>
                                <div class="panel-body" id="bar-parent10">
                                    <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
										...
										<div class="form-group row" id="mn_vehicle" >
                                            ...
                                            <div class="col-lg-4 col-md-3">
                                                <select id="vehicle" name="vehicle" class="form-control select2" >
													...
													<option value="142045257806">Office Tes</option>
													<?php 
														$cvehicle = count($vehicles);
															for($i=0;$i<$cvehicle;$i++){
																echo "<option value='" . $vehicles[$i]->vehicle_mv03 ."' " . $selected . ">" . $vehicles[$i]->vehicle_no ." - ".$vehicles[$i]->vehicle_mv03. "</option>";
																}
													?>
										...
										<div class="form-group row">
											<label class="col-lg-3 col-md-4 control-label">Channel
                                            </label>
											
                                            <div class="col-lg-3 col-md-4">
                                               <select class="form-control" id="channel" name="channel">
													<!--<option value="-1">All</option>-->
													<option value="0">Channel 1 (DSM)</option>
													<option value="1">Channel 2 (ADAS)</option>
										...
										<div class="form-group row">
											<label class="col-lg-3 col-md-4 control-label">Secret Code
                                            </label>
											
											<div class="col-lg-3 col-md-4">
												<input class="form-control" size="5" type="password" id="verifcode" name="verifcode" value="">
											</div>
										</div>
