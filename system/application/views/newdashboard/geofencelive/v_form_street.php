                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <legend>Control</legend>
                          ...
                          <input class="btn btn-warning" type="button" name="btncancel" id="btncancel" value=" <?php echo $this->lang->line("lreset"); ?> " onclick="location='<?=base_url()?>geofencedatalive/managestreet/<?php echo $this->uri->segment("3"); ?>/<?php echo $this->uri->segment("4"); ?>/<?php echo uniqid();?>';" />
                      </fieldset>
                    </td>
                  </tr>
                </table>
