        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-2">
                <select class="form-control select2" name="summary_mapsoption" id="summary_mapsoption" onchange="summary_mapsoptiononchange()">
                  <option value="0">--All Engine Status</option>
                  <option value="1">Engine On</option>
                  <option value="2">Engine Off</option>
                </select>
              </div>
      ...
      <div class="card" id="cardShowMap">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-4" id="summarymapsshowhide">
              <div class="row">
                <div class="col-md-12">
                  <button type="button" class="btn btn-primary btn-lg form-control" style="margin-bottom:2%;" onclick="getTotalUnit();">Total Unit : <span id="summary_totalunit"></span> </button>
                </div>
              </div>

              <div class="row" style="margin-bottom:2%;">
                <div class="col-md-12">
                  <button type="button" class="btn btn-primary btn-lg form-control" onclick="getTotalInRom();">ROM : <span id="summary_totalrom"></span> </button>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="info-box bg-blue">
                    <div class="info-box-content" style="margin-top: -3%; margin-left: 25%;">
                      <span class="info-box-text" style="font-size:18px;">
                        KOSONGAN
                      </span>
                      <span class="info-box-number" id="summary_totalkosongan" style="font-size:25px;"><b></b></span>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="info-box bg-success">
                    <div class="info-box-content" style="margin-top: -3%; margin-left: 25%;">
                      ...
                      <span class="info-box-number" id="summary_totalmuatan" style="font-size:25px;"><b></b></span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row" style="margin-bottom:2%;">
                <div class="col-md-12">
                  <button type="button" class="btn btn-lg form-control" style="background-color: black; color:white;" onclick="getTotalInPort();">PORT : <span id="summary_totalport"></span> </button>
                </div>
              </div>

              <div class="row" style="margin-bottom:2%;">
                <div class="col-md-12">
                  <!-- <button type="button" class="btn btn-primary btn-lg form-control">POOL : <span id="summary_totalpool"></span> </button> -->
                  <button type="button" class="btn btn-primary btn-lg form-control" onclick="getTotalInPool();">POOL : <span id="summary_totalpool"></span> </button>
                </div>
              </div>

              <div class="row" style="margin-bottom:2%;">
                <div class="col-md-12">
                  <button type="button" class="btn btn-lg form-control" style="background-color:purple; color:white;">Non-BIB Area : <span id="summary_totalnonbibarea"></span> </button>
                </div>
              </div>

              <div class="row">
                <div class="col-md-12">
                  <button type="button" class="btn btn-warning btn-lg form-control">Offline Vehicle : <span id="summary_totalofflinevehicle"></span> </button>
                </div>
              </div>
            </div>
                ...
                <div class="panel-body" id="bar-parent10">
                  <div id="realtimealertcontent"></div>
                    <table class="table">
                      ...
                      <div style="overflow-x: auto;height: 330px; max-height: 330px;">
                        <div id="evidencealertcontent" style="font-size:10px; margin-top: 1%; height: 80px; max-height: 85px;"></div>
                        <div id="summaryalertcontent" style="font-size:10px; margin-top: 1%; height: 430px; max-height: 430px;"></div>
                      </div>
                    </table>
                </div>
...
<script>
  $(document).ready(function() {
    setTimeout(function(){
      ...
      appendsummarymapsoption();
    }, 3000);

    function appendsummarymapsoption(){
      var summary_mapsoption          = $("#summary_mapsoption").val();
      var contractor                  = $("#contractor").val();

      var data = {
        summary_mapsoption : summary_mapsoption,
        contractor : contractor,
      };

      $.post("<?php echo base_url() ?>maps/getsummarymapsoptionawal", data, function(response){
        console.log("response : ", response);

        $("#summary_totalunit").html(response.totalunit);
        $("#summary_totalrom").html(response.totalinrom);
        $("#summary_totalport").html(response.totalinport);
        $("#summary_totalnonbibarea").html(response.totaloutofhauling);
        $("#summary_totalofflinevehicle").html(response.totalofflinevehicle);
        $("#summary_totalkosongan").html(response.totalkosongan);
        $("#summary_totalmuatan").html(response.totalmuatan);
        $("#summary_totalpool").html(response.totalinpool);
      },"json");
    }
  ...
  function getTotalUnit(){
    ...
    $.post("<?php echo base_url() ?>maps/getSummaryTotalUnit", data, function(response){
      console.log("response getTotalUnit : ", response);
      ...
      var htmlpool = "";
        if (datafix.length > 0) {
          ...
          $("#modalStateTitle").html("Total Unit (" + totalrow + ")");
          ...
          htmlpool += '<table class="table table-striped">';
            htmlpool += '<thead>';
              htmlpool += '<tr>';
                ...
                htmlpool += '<th align="center">Position</th>';
          ...
          for (var i = 0; i < datafix.length; i++) {
            ...
            var speedromfix = "";
              ...
              htmlpool += '<tr>';
                ...
                htmlpool += '<td align="center" style="font-size:12px;color:black"><span style="color:black;">'+datafix[i].vehicle_position+'</span>';
  ...
  function getTotalInRom(){
    ...
    $.post("<?php echo base_url() ?>maps/getSummaryTotalUnitInRom", data, function(response){
      console.log("response getSummaryTotalUnitInRom : ", response);
      ...
      var htmlpool = "";
        if (datafix.length > 0) {
          var lastcheckpoolws = "Last Check : "+response.data[0].auto_last_update + " WITA";
          $("#modalStateTitle").html("Total in ROM (" + totalrow + ")");
          $("#lastcheckpoolws").html(lastcheckpoolws);
          htmlpool += '<table class="table table-striped">';
            htmlpool += '<thead>';
              htmlpool += '<tr>';
  ...
  function getTotalInPort(){
    ...
    $.post("<?php echo base_url() ?>maps/getSummaryTotalUnitInPort", data, function(response){
      console.log("response getSummaryTotalUnitInRom : ", response);
      ...
      var htmlpool = "";
        if (datafix.length > 0) {
          var lastcheckpoolws = "Last Check : "+response.data[0].auto_last_update + " WITA";
          $("#modalStateTitle").html("Total in PORT (" + totalrow + ")");
          $("#lastcheckpoolws").html(lastcheckpoolws);
          htmlpool += '<table class="table table-striped">';
            htmlpool += '<thead>';
              htmlpool += '<tr>';
  ...
  function getTotalInPool(){
    ...
    $.post("<?php echo base_url() ?>maps/getSummaryTotalUnitInPool", data, function(response){
      console.log("response getSummaryTotalUnitInPool : ", response);
      ...
      var htmlpool = "";
        if (datafix.length > 0) {
          var lastcheckpoolws = "Last Check : "+response.data[0].auto_last_update + " WITA";
          $("#modalStateTitle").html("Total in POOL (" + totalrow + ")");
          $("#lastcheckpoolws").html(lastcheckpoolws);
          htmlpool += '<table class="table table-striped">';
            htmlpool += '<thead>';
              htmlpool += '<tr>';
  ...
  function summary_mapsoptiononchange(){
    var summary_mapsoption          = $("#summary_mapsoption").val();
    var contractor                  = $("#contractor").val();
    ...
    $.post("<?php echo base_url() ?>maps/getsummarymapsoptionbyfilter", data, function(response){
      // console.log("summary maps filter engine : ", response);
  ...
  function simultango() {
    ...
    // console.log("nopolforcheck : ", nopolforcheck);
      ...
      // GET SUMMARY MAPS OPTION
      summary_mapsoptiononchange();
...
var intervalalert = setInterval(dataalert, 10000);
var lasttimealert = 0;
var limitalert    = 10;

var lasttimealert_evidence = "";

var intervalevidencealert = setInterval(evidence_realtimealert, 15000);

function evidence_realtimealert(){
  $.post("<?php echo base_url() ?>securityevidence/securityevidence_realtimealert", {lasttimealert_evidence : lasttimealert_evidence, limitalert : limitalert}, function(response){
    // console.log("response evidence alert : ", response);

    var simultan           = response.simultan;
    lasttimealert_evidence = response.lasttime;
    var datafix            = response.data;

    if (response.code == 200) {
      if (simultan == "no") {
        evidencealert.push(response.data);

        var htmlevidencealert = "";
          htmlevidencealert += '<span style="font-size:11px; color:green;" onclik="forsearchfromalert("'+datafix.vehicle_no+'")">'+ datafix.vehicle_no +'</span> <span style="font-size:11px; color:red;">'+ datafix.gps_alert +'</span> <span style="font-size:11px;">'+ datafix.gps_time +'</span> </br> <a style="font-size:11px;" href="http://maps.google.com/maps?z=12&t=m&q=loc'+datafix.gps_latitude_real+'" target="_blank">'+ " "+datafix.position +' </a> <span style="font-size:11px; color:black;">'+ 'Speed : '+ datafix.gps_speed +
          ' Kph </br><hr>';
          realtimealertarraysummary.push(evidencealert[evidencealert.length-1]);
          evidencealert = [];
      }else {
        evidencealert.push(response.data);
        $("#evidencealertcontent").show();
        // var lastelement = evidencealert[evidencealert.length-1];
        // console.log("evidence simultan : ", evidencealert);
      ...
      $("#evidencealertcontent").html(htmlevidencealert);
    }
  }, "json");
}
...
function dataalert(){
  $.post("<?php echo base_url() ?>securityevidence/realtimealert", {lasttimealert : lasttimealert, limitalert : limitalert}, function(response){
    // var arraylength;
    // var selisih;
    if (evidencealert.length < 1) {
      // console.log("evidencealert on Hide Mode");
      $("#evidencealertcontent").hide();
    }else {
      $("#evidencealertcontent").show();
    }
    ...
    if (response.code == 200) {
      ...
      if (realtimealertarraysummary.length >= limitalert) {
        var data = response.data;
          ...
          // arraylength      = realtimealertarraysummary.length;
          // selisih          = arraylength - limitalert;
          // var alertaftersplice = [];alertaftersplice =
          realtimealertarraysummary.shift();
          // for (var i = 0; i < selisih; i++) {
            // var indexarray       = realtimealertarraysummary.indexOf(0);
            //     realtimealertarraysummary.splice(0, 1);
              // console.log("HAPUS INDEX TERAKHIR : " + indexarray);
              // console.log("HAPUS INDEX KE 0 : ");
          // }

        // var realtimealertarraysummaryreverse = realtimealertarraysummary.reverse();
        // console.log("realtimealertarraysummaryreverse IF : ", realtimealertarraysummaryreverse);
      }else {
        var data = response.data;
          for (var i = 0; i < data.length; i++) {
            var positionalert   = data[i].position.includes("KM");
        ...
        // var realtimealertarraysummaryreverse = realtimealertarraysummary.reverse();
        // console.log("realtimealertarraysummaryreverse ELSE : ", realtimealertarraysummaryreverse);
      }
      ...
      console.log("realtimealertarraysummaryreverse : ", realtimealertarraysummaryreverse);
        ...
        for (var i = 0; i < realtimealertarraysummaryreverse.length-1; i++) {
          if (realtimealertarraysummaryreverse[i].isfatigue) {
            if (realtimealertarraysummaryreverse[i].isfatigue == "yes") {
              var isfatigue = "";
            }else {
              var isfatigue = 'Limit : '+ realtimealertarraysummaryreverse[i].gps_speed_limit +' Kph </span> '+
              '<span style="font-size:11px; color:black;">'+ realtimealertarraysummaryreverse[i].jalur_name;
            }
          }else {
            var isfatigue = 'Limit : '+ realtimealertarraysummaryreverse[i].gps_speed_limit +' Kph </span> '+
            '<span style="font-size:11px; color:black;">'+ realtimealertarraysummaryreverse[i].jalur_name;
...
function getPoolByParent(id){
  ...
  jQuery("#loader2").show();
  $("#poolparentID").val(id);
  $.post("<?php echo base_url() ?>maps/getChildPool", {poolparent : id}, function(response){
