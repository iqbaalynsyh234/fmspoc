  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div id="tableShowPort" style="width: 100%; max-height: 400px; display:none;">
        ...
        <div class="row" id="contentport"></div>
      </div>
...
function showTableRom(){
  ...
  $.post("<?php echo base_url() ?>maps/getstreetautomatic", {typeofstreet:3}, function(response){
    // console.log("response : ", response);
    $("#contentrom").html("");
...
function showTablePort(){
  ...
  $.post("<?php echo base_url() ?>maps/getstreetautomatic", {typeofstreet:4}, function(response){
    // console.log("response : ", response);
    $("#contentrom").html("");
    ...
    for (var i = 0; i < totaldata; i++) {
      ...
      htmlport += '<div class="col-xl-3 col-md-6 col-12" onclick="listVehicleOnPort('+allStreet[i].street_id+')" style="cursor : pointer;">';
        htmlport += '<div class="info-box bg-blue">';
          htmlport += '<span class="info-box-icon push-bottom" style="margin-top:4%;">';
            htmlport += '<i class="material-icons" style="font-size:50px; padding-top:10px;">directions_boat</i>';
          htmlport += '</span>';
          htmlport += '<div class="info-box-content">';
            htmlport += '<span class="info-box-text" style="font-size:15px;">'+datainport[i][0]+'</span>';
            htmlport += '<span class="info-box-number" style="font-size:22px;"><b>'+datainport[i][1]+'</b></span>';
          htmlport += '</div>';
        htmlport += '</div>';
      htmlport += '</div>';
    }

    $("#contentport").html(htmlport);
...
function showTablePool(){
  ...
  $.post("<?php echo base_url() ?>maps/getstreetautomatic", {typeofstreet:2}, function(response){
    // console.log("response : ", response);
    $("#contentrom").html("");
