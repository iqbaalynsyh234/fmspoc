                      ...
                      <div class="col-md-2">
                        <table class="table table-bordered" style="font-size:12px;">
                            <tr>
                              <td>
                                <div class="btn-group">
                                  <div type="button" class="" id="labelvehicleoutofhauling"></div>
                                  <div type="button" class="" id="vehicleoutofhauling"></div>
                                </div>
                              </td>
                            </tr>
                        </table>
                    ...
                    <div class="col-md-2">
                      <table class="table table-bordered" style="font-size:12px;">
                          <tr>
                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_bbs"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_bbs"></div>
                              </div>
                            </td>

                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_bka"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_bka"></div>
                              </div>
                            </td>

                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_bsl"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_bsl"></div>
                              </div>
                            </td>

                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_gecl"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_gecl"></div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_kusan_bawah"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_kusan_bawah"></div>
                              </div>
                            </td>

                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_kusan"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_kusan"></div>
                              </div>
                            </td>

                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_mks"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_mks"></div>
                              </div>
                            </td>

                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_ram"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_ram"></div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_rbt"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_rbt"></div>
                              </div>
                            </td>

                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinpool_stli"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinpool_stli"></div>
                              </div>
                            </td>

                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinws_gecl"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinws_gecl"></div>
                              </div>
                            </td>

                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinws_kmb"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinws_kmb"></div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td>
                              <div class="btn-group">
                                <div type="button" class="btn btn-primary" id="labelvehicleinws_mks"></div>
                                <div type="button" class="btn btn-primary dropdown-toggle m-r-20" id="vehicleinws_mks"></div>
                              </div>
                            </td>
                          </tr>
...
function showTableMuatan(sikon){
  ...
  $.post("<?php echo base_url() ?>maps/dataconsolidated", {}, function(response){
    ...
    // console.log("sizekosongan : ", sizekosongan);
      ...
      if (sikon == 1) {
        $("#lastupdateconsolidated").html("Total Kosongan : " +totalKosongan+" || Total Muatan : " +totalMuatan+ " || Last Update : "+lastupdate);
        $("#lastupdateconsolidated").show();
      }else {
        $("#lastupdateconsolidated").html("Total Kosongan : " +totalKosongan+" || Total Muatan : " +totalMuatan);
        $("#lastupdateconsolidated").show();
      }
  },"json");
}
...
function showTablePool(){
  ...
  $.post("<?php echo base_url() ?>maps/vehicleonpool", {}, function(response){
    console.log("response : ", response);
    var datainpool      = JSON.parse(response.data[0].minidashboard_json);
    var arraydatainpool = Object.keys(datainpool).map((key) => [String(key), datainpool[key]]);
    var size            = arraydatainpool.length;

    var labelvehicleinpool_bbs        = "POOL BBS";
    var vehicleinpool_bbs             = arraydatainpool[0][1];
      $("#labelvehicleinpool_bbs").html(labelvehicleinpool_bbs);
      $("#vehicleinpool_bbs").html(vehicleinpool_bbs);
        if (vehicleinpool_bbs > 30 && vehicleinpool_bbs < 51) {
      ...
      var vehicleinpool_kusan_bawah             = arraydatainpool[4][1];
        ...
        $("#vehicleinpool_kusan_bawah").html(vehicleinpool_kusan_bawah);
          if (vehicleinpool_kusan_bawah > 30 && vehicleinpool_kusan_bawah < 51) {
      ...
      var vehicleinws_mks             = arraydatainpool[12][1];
        ...
        $("#vehicleinws_mks").html(vehicleinws_mks);
          ...
          var jumlahtotalinpool = parseFloat(vehicleinpool_bbs + vehicleinpool_bka + vehicleinpool_bsl + vehicleinpool_gecl + vehicleinpool_kusan_bawah + vehicleinpool_kusan + vehicleinpool_mks + vehicleinpool_ram + vehicleinpool_rbt + vehicleinpool_stli + vehicleinws_gecl + vehicleinws_kmb + vehicleinws_mks);
...
function showOutOfHauling(){
  ...
  $.post("<?php echo base_url() ?>maps/outofhauling", {}, function(response){
    console.log("response : ", response);
    var dataoutofhauling        = JSON.parse(response.data[0].minidashboard_json);
    var arraydataoutofhauling   = Object.keys(dataoutofhauling).map((key) => [String(key), dataoutofhauling[key]]);
    var sizeoutofhauling        = dataoutofhauling.length;
    var totaloutofhauling       = 0;

    // console.log("arraydataoutofhauling : ", arraydataoutofhauling[0]);
    // console.log("sizekosongan : ", sizekosongan);

    var labelvehicleoutofhauling        = "Out Of Hauling";
    var vehicleoutofhauling             = arraydataoutofhauling[0][1];
      ...
      $("#vehicleoutofhauling").html(vehicleoutofhauling);
        ...
        $("#vehicleoutofhauling").html(jumlahfix);


    $("#jumlahtotaloutofhauling").html("Total : " +totaloutofhauling);
  ...
  $.post("<?php echo base_url() ?>securityevidence/realtimealert", {lasttimealert : lasttimealert, limitalert : limitalert}, function(response){
    ...
    if (response.code == 200) {
      ...
      for (var i = 0; i < realtimealertarraysummaryreverse.length-1; i++) {
        ...
        htmlsummary += '<span style="font-size:12px; color:green;">'+ realtimealertarraysummaryreverse[i].vehicle_no +'</span> <span style="font-size:12px; color:red;">'+ realtimealertarraysummaryreverse[i].gps_alert +'</span> <span style="font-size:12px;">'+ realtimealertarraysummaryreverse[i].gps_time +'</span> </br> <a style="font-size:12px;" href="http://maps.google.com/maps?z=12&t=m&q=loc'+realtimealertarraysummaryreverse[i].gps_latitude_real+','+realtimealertarraysummaryreverse[i].gps_longitude_real+'" target="_blank">'+ " "+realtimealertarraysummaryreverse[i].position +' </a> <span style="font-size:12px; color:black;">'+ 'Speed : '+ realtimealertarraysummaryreverse[i].gps_speed +' Kph </span> <span style="font-size:12px; color:red;">'+ 'Limit : '+ realtimealertarraysummaryreverse[i].gps_speed_limit +' Kph </span> </br><hr>';
      }
