...
<script>
  $(document).ready(function() {
    ...
    function appendthecontractorlist(){
      $.post("<?php echo base_url() ?>maps/getdatacontractorvehiclebib", {}, function(response){
  ...
  function changevehiclelist(){
    ...
    $.post("<?php echo base_url() ?>maps/getvehiclebycontractorvehiclebib", {companyid : companyid}, function(response){
      // console.log("response : ", response);
      var data = response.data;
      var html = "";
...
function standardMaps(){
  ...
  jQuery("#loader2").show();
  $.post("<?php echo base_url() ?>maps/mapsstandardvehiclebib", {companyid : companyid}, function(response){
    jQuery("#loader2").hide();

    console.log("response mapsstandardvehiclebib : ", response);
    ...
    for (i = 0; i < objmapsstandard.length; i++) {
      ...
      google.maps.event.addListener(marker, 'click', (function(marker, i) {
        return function() {
          ...
          $.post("<?php echo base_url() ?>maps/getdetailbydevidvehiclebib", data, function(response){
...
function simultangomapsstandard() {
  ...
  jQuery("#loader2").show();
  jQuery.post("<?=base_url();?>map/mapsstandardvehiclebiblastinfoall", {companyid : companyid}, function(response) {
    jQuery("#loader2").hide();

    console.log("response mapsstandardvehiclebiblastinfoall simultan : ", response);
    var vehicle             = response.data;
    var bounds              = new google.maps.LatLngBounds();
...
function getVehicleByContractor(){
  ...
  $.post("<?php echo base_url() ?>maps/vehiclebibByContractor", {companyid : companyid, valuemapsoption: 9999}, function(response){
