      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <div class="input-group">
                    <input type="text" name="searchnopol" id="searchnopol" placeholder="input vehicle no">
                    <span class="input-group-btn search-btn">
                      <a href="javascript:;" class="btn btn-success" id="btnSearchNopol" onclick="forsearchinput()">
                         <i class="icon-magnifier"></i>
                       </a>
                    </span>
                    <button type="button" name="button" class="btn btn-success btn-sm" id="heatmapbutton" style="margin-left:2%;" onclick="showHeatmap();">Maps</button>
                    <button type="button" name="button" class="btn btn-primary btn-sm" id="muatanbutton" style="margin-left:2%;" onclick="showTableMuatan();">Muatan</button>
                    <button type="button" name="button" class="btn btn-flat btn-sm" id="kosonganbutton" style="margin-left:2%;" onclick="showTableKosongan();">Kosongan</button>
                    <button type="button" name="button" class="btn btn-default btn-sm" id="rombutton" style="margin-left:2%;" onclick="showTableRom();">ROM</button>
                    <button type="button" name="button" class="btn btn-warning btn-sm" id="poolbutton" style="margin-left:2%;" onclick="showTablePort();">PORT</button>
            ...
            <div class="row">
              <div class="col-md-12">
                <div id="tableShowMuatan" style="width: 100%; max-height: 430px; display:none;">
                  <!-- display:none; -->
                  <div class="row">
                    <div class="col-md-2">
                      <ul class="timeline">
              ...
              <div class="col-md-12">
                <div id="tableShowKosongan" style="width: 100%; max-height: 430px; display:none;">
                  <div class="row">
                    <div class="col-md-2">
                      <ul class="timeline">
                        <?php for ($i=30; $i > 25; $i--) {?>
                          <li class="timeline-inverted">
                            <div class="" id="labelvehicleonkosongan<?php echo $i ?>">KM <?php echo $i; ?></div>
                            <div class="timeline-panel"></div>
                          </li>
                          <li class="timeline-inverted">
...
function showTableMuatan(){
  ...
  $.post("<?php echo base_url() ?>maps/vehicleonkmmuatan", {}, function(response){
    // console.log("response : ", response);
    var datamuatan      = JSON.parse(response.data[0].minidashboard_json);
    var arraydatamuatan = Object.keys(datamuatan).map((key) => [String(key), datamuatan[key]]);
    var size            = arraydatamuatan.length;
    ...
    // console.log("arraydatamuatan : ", arraydatamuatan[0][1]);
      for (var i = 0; i < size; i++) {
        ...
        if (jumlahfix >= middle_limit && jumlahfix < top_limit) {
          $("#labelvehicleonmuatan"+i).addClass('timeline-badge btn btn-warning btn-lg');
          $("#vehicleonmuatan"+i).addClass('timeline-badge2 btn btn-warning btn-md btn-circle dropdown-toggle m-r-20');
        }else if(jumlahfix >= top_limit){
          $("#labelvehicleonmuatan"+i).addClass('timeline-badge btn btn-danger btn-lg');
          $("#vehicleonmuatan"+i).addClass('timeline-badge2 btn btn-danger btn-md btn-circle dropdown-toggle m-r-20');
        }else {
          $("#labelvehicleonmuatan"+i).addClass('timeline-badge btn btn-primary btn-lg');
          $("#vehicleonmuatan"+i).addClass('timeline-badge2 btn btn-primary btn-md btn-circle dropdown-toggle m-r-20');
        }
...
function showTableKosongan(){
  ...
  $("#tableShowPort").hide();
  $("#tableShowRom").hide();
  $("#tableShowKosongan").show();
  soundisactive = 0;

  $.post("<?php echo base_url() ?>maps/vehicleonkmkosongan", {}, function(response){
    // console.log("response : ", response);
    var datakosongan      = JSON.parse(response.data[0].minidashboard_json);
    var arraydatakosongan = Object.keys(datakosongan).map((key) => [String(key), datakosongan[key]]);
    var size              = arraydatakosongan.length;
    // console.log("datamuatan : ", datamuatan);
    // console.log("arraydatakosongan : ", arraydatakosongan[0][1]);
      for (var i = 0; i < size; i++) {
        var jumlahfix = arraydatakosongan[i][1]; //30+i; //arraydatamuatan[i][1];
        if (jumlahfix >= middle_limit && jumlahfix < top_limit) {
          $("#labelvehicleonkosongan"+i).addClass('timeline-badge btn btn-warning btn-lg');
          $("#vehicleonkosongan"+i).addClass('timeline-badge2 btn btn-warning btn-md btn-circle dropdown-toggle m-r-20');
        }else if(jumlahfix >= top_limit){
          $("#labelvehicleonkosongan"+i).addClass('timeline-badge btn btn-danger btn-lg');
          $("#vehicleonkosongan"+i).addClass('timeline-badge2 btn btn-danger btn-md btn-circle dropdown-toggle m-r-20');
        }else {
          $("#labelvehicleonkosongan"+i).addClass('timeline-badge btn btn-primary btn-lg');
          $("#vehicleonkosongan"+i).addClass('timeline-badge2 btn btn-primary btn-md btn-circle dropdown-toggle m-r-20');
        }
