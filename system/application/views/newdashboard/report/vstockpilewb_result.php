								...
								<tbody>
								 <?php if(isset($data) && (count($data) > 0)){
											...
											<tr>
												...
												<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->stockpile_report_material_name_wb;?></td>
									...
									<tr>
										<td style="text-align:center;font-size:14px;" colspan='2'>Coal Hauling</td>
