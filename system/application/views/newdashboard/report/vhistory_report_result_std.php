...
<div class="row">
	<div class="col-md-12 col-sm-12">
		<div class="panel">
			<header class="panel-heading panel-heading-red">MAP</header>
...
<script>
       ...
       coords = [];
            ...
            coords.push({
              lat: parseFloat(obj[x].latitude),
              lng: parseFloat(obj[x].longitude)
            });
        }
       ...
       // Add multiple markers to map
        infowindow      = new google.maps.InfoWindow();
         ...
         var position2 = new google.maps.LatLng(parseFloat(coords[coords.length-1].lat), parseFloat(coords[coords.length-1].lng));
       ...
       // SAMPLE UNTUK MOVE MARKER AND POLYLINE
       /*var bounds = new google.maps.LatLngBounds();
       ...
       var icon = {
        ...
        let map = new google.maps.Map(document.getElementById("map"), {
               center: new google.maps.LatLng(markLAT, markLNG), //markLAT, markLNG
               zoom: 16, //18
               mapTypeId: google.maps.MapTypeId.SATELLITE,
               options: {
                 gestureHandling: 'greedy'
       ...
       for (i = 1; i < coords.length; i++) {
         // console.log("lat : ", coords[i].lat);
         // console.log("lng : ", coords[i].lng);
            (function(i){
               setTimeout(function(){
                marker.setPosition(coords[i]);
                map.setCenter(marker.position);
                polyline.getPath().push(new google.maps.LatLng(coords[i].lat, coords[i].lng));
             }, 1000 * i);
           }(i));
        }
        polyline.setMap(map);*/
