<script>
	...
	function page(p) {
		...
		jQuery("#loader2").show();
		jQuery("#result").hide();
		jQuery.post("<?= base_url(); ?>ritasesummary/search", jQuery("#frmsearch").serialize(),
			function(r) {
				console.log(r);
				if (r.error) {
					alert(r.message);
	...
	function company_onchange() {
		...
		if (data_company == 0) {
			...
			jQuery("#vehicle").html("<option value='all' selected='selected'>--All Vehicle--</option>");
		} else {
			jQuery("#mn_vehicle").show();

			var site = "<?= base_url() ?>ritasesummary/get_vehicle_by_company_with_numberorder/" + data_company;
			jQuery.ajax({
				url: site,
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<div class="panel" id="panel_form">
					<header class="panel-heading panel-heading-red">RITASE (DETAIL) REPORT</header>
						...
						<form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
							...
							<div class="form-group row">
								...
								<div class="col-lg-3 col-md-3">
									...
									<img id="loader2" style="display: none;" src="<?php echo base_url(); ?>assets/transporter/images/loader2.gif" />
								</div>
