...
function page(p)
	{
		...
		jQuery("#loader2").show();
		jQuery.post("<?=base_url();?>overspeedreport/search", jQuery("#frmsearch").serialize(),
			function(r)
			{
				if (r.error) {
					alert(r.message);
                    ...
                    <div class="row">
						<div class="col-md-12 col-sm-12">
                            <div class="panel" id="panel_form">
                                <header class="panel-heading panel-heading-red">OVERSPEED REPORT</header>
                                <div class="panel-body" id="bar-parent10">
                                    <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
										...
										<div class="form-group row" id="mn_vehicle" >
                                            ...
                                            <div class="col-lg-4 col-md-3">
                                                 <input class="form-control" size="5" type="text" name="km" id="km" value="" placeholder="ex: 5,6.5,7">
																								 <p style="font-size:10px; color:red;">
																									 <i>Gunakan koma sebagai pemisah KM yang ingin dicari</i>
																								 </p>
                                            </div>
										 </div>
