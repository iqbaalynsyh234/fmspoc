<script>
  ...
  function page(p) {
    ...
    jQuery.post("<?=base_url();?>tripreport/search_history_direction/", jQuery("#frmsearch").serialize(),
      function(r) {
        if (r.error) {
          alert(r.message);
          jQuery("#loader2").hide();
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading-blue">HISTORY MAP WITH DIRECTION</header>
