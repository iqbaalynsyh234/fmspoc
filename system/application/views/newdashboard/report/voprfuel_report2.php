...
function page(p)
	{
		...
		jQuery("#loader2").show();
		jQuery.post("<?=base_url();?>fuelopr2/search_operational", jQuery("#frmsearch").serialize(),
			function(r)
			{
				if (r.error) {
					alert(r.message);
                            ...
                            <div class="panel" id="panel_form">
                                ...
                                <div class="panel-body" id="bar-parent10">
                                    <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
										...
										<div class="form-group row" style="display:none;">
                                            ...
                                            <div class="col-lg-3 col-md-4">
                                              <select class="form-control" id="statusname" name="statusname">
													...
													<option value="MOVE2">MOVE 2</option>
										...
										<div class="form-group row" style="display:none;">
											<label class="col-lg-3 col-md-4 control-label">Geofence Type
                                            </label>
                                            <div class="col-lg-3 col-md-4">
                                              <select class="form-control" id="geotype" name="geotype">
													...
													<option value="site">ROM</option>
													<!--<option value="stop">STOP</option>-->
													<!--<option value="out">Out Of Geofence</option>-->
												</select>
											 </div>
										...
										<div class="form-group row" style="display:none;">
                                            ...
                                            <div class="col-lg-3 col-md-4">
												...
												<div id="location_view" style="display:none"> 
													Location Start: <input class="form-control" type="text" name="location_start" id="location_start" value="" size="50" placeholder="Ex: KM 5.5"/>
