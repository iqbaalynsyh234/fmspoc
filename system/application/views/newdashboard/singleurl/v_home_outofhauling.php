        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-3" id="showSearchNOutOfHauling">
...
<script>
  ...
  intervaloutofhauling = setInterval(showOutOfHauling, 3000);
    ...
    var htmlpool = "";
      if (datafix.length > 0) {
        ...
        for (var i = 0; i < datafix.length; i++) {
          ...
          var speedoutofhaulingfix = datafix[i].auto_last_speed;
          var lastenginefix;

            if (enginekmfix == "OFF" && speedoutofhaulingfix > 0) {
              lastenginefix = "ON";
            }else {
            ...
            htmlpool += '<tr>';
              ...
              htmlpool += '<td align="center" style="font-size:12px;color:black"><span style="color:black;">'+speedoutofhaulingfix+'</span>';
