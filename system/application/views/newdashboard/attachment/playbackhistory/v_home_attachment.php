...
<div class="row" style="margin-left:4px; margin-right:4px; margin-bottom:12px; background-color:#f2f2f2; padding-top:10px; padding-bottom:10px;">
  ...
  <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding-bottom: 2px; margin-bottom:2px;">
    ...
    <i class="fa fa-car">
      <span id="alertvehicle">
        <?php
          if (isset($vehicle_no) && isset($vehicle_name)) {
            $vehiclenofix = $vehicle_no;
            $vehiclenamefix = $vehicle_name;
            echo $vehiclenofix . ' ' . $vehiclenamefix;
          }else {
            echo "Data empty";
          }
          ?>
  ...
  <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding-bottom: 2px; margin-bottom:2px;">
    <i class="fa fa-clock-o">
      <?php if (isset($sdate)) {?>
        <span id="alerttime"><?php echo date("d-m-Y H:i:s", strtotime($sdate)) ?></span>
      <?php }else {
        echo "Data empty";
      } ?>
    </i>
  ...
  <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding-bottom: 2px; margin-bottom:2px;">
    <i class="fa fa-clock-o">
      <?php if (isset($edate)) {?>
        <span id="alerttime"><?php echo date("d-m-Y H:i:s", strtotime($edate)) ?></span>
      <?php }else {
        echo "Data empty";
      } ?>
    </i>
...
<div class="row justify-content-center" style="margin-left:4px; margin-right:4px; margin-bottom:12px; background-color:#f2f2f2; padding-top:10px; padding-bottom:10px;">
  <div class="col-lg-12 col-md-12 col-sm-10 col-xs-12" style="padding-bottom: 2px; margin-bottom:2px;">
    <div class="row">
      	<div class="col-md-12 col-sm-12">
      		<div class="panel">
      			<header class="panel-heading panel-heading-red">PLAYBACK HISTORY</header>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="row" style="margin-left: 1%;">
                      <button id="btn_play_marker" class="btn btn-circle btn-primary btn-sm" type="button" onclick="btn_play_marker()">
                        <span class="fa fa-play"></span>
                      </button>

                      <button id="btn_resume_marker" class="btn btn-circle btn-success btn-sm" type="button" onclick="btn_resume_marker()" style="display: none;">
                        <span class="fa fa-play"></span>
                      </button>

                      <button id="btn_pause_marker" class="btn btn-circle btn-warning btn-sm" type="button" onclick="btn_pause_marker()" style="display: none;">
                        <span class="fa fa-pause"></span>
                      </button>

                      <button id="btn_return_marker" class="btn btn-circle btn-danger btn-sm" type="button" onclick="btn_return_marker()" style="display:none;">
...
window.clearInterval(foranimate);
       ...
       console.log("objawals : ", objawal);
       console.log("objawals.length : ", objawal.length);
       ...
       coords = [];
          ...
          var latitude_format = obj[x].gps_latitude_real;
					...
					// var longitude_fix = "";
          // var latitude_fix = "";
          //   if (longitude_format.length > 7) {
          //     // longitude_fix = obj[(x-1)].gps_longitude_real;
          //     longitude_fix = obj[x].gps_longitude_real;
          //   }
          //
          //   if (latitude_format.length > 7) {
          //     // longitude_fix = obj[(x-1)].gps_longitude_real;
          //     latitude_fix = obj[x].gps_latitude_real;
          //   }
       ...
       var speedmarker  = 250;
        ...
        function btn_play_marker(){
          document.getElementById("btn_play_marker").style.display = 'none';
          document.getElementById("btn_resume_marker").style.display = 'none';
          document.getElementById("btn_return_marker").style.display = 'block';
          document.getElementById("btn_pause_marker").style.display = 'block';
          playAnimate();
        }

        function btn_pause_marker(){
          document.getElementById("btn_pause_marker").style.display = 'none';
          document.getElementById("btn_play_marker").style.display = 'none';
          document.getElementById("btn_return_marker").style.display = 'block';
          document.getElementById("btn_resume_marker").style.display = 'block';
          pauseAnimate();
        }

        function btn_resume_marker(){
          document.getElementById("btn_play_marker").style.display = 'none';
          document.getElementById("btn_resume_marker").style.display = 'none';
          document.getElementById("btn_return_marker").style.display = 'block';
          document.getElementById("btn_pause_marker").style.display = 'block';
        ...
        function btn_return_marker(){
          document.getElementById("btn_return_marker").style.display = 'block';
          document.getElementById("btn_play_marker").style.display = 'block';
          document.getElementById("btn_resume_marker").style.display = 'none';
          document.getElementById("btn_pause_marker").style.display = 'none';
...
<?php
	...
	//$key = "AIzaSyDTzBAgqzSvZDDjA-5z3u7C7C8Z1VCsLaw";
