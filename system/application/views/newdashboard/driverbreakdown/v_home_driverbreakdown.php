...
<script>
  ...
  function page(p) {
    ...
    jQuery("#loader2").show();
    jQuery.post("<?=base_url();?>driverbreakdown/searchthis", jQuery("#frmsearch").serialize(),
      function(r) {
        if (r.error) {
          alert(r.message);
          jQuery("#loader2").hide();
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading" id="breakdown">BREAKDOWN REPORT</header>
                 ...
                 <div class="col-lg-4 col-md-3">
                   <select id="vehicle" name="vehicle" class="form-control select2">
                     ...
                     <?php
 												...
 												<option value="<?php echo $datavehicle[$i]['vehicle_device'] ?>"><?php echo $datavehicle[$i]['vehicle_no'].' '.$datavehicle[$i]['vehicle_name'] ?></option>
 													<?php }?>
                   </select>
                 </div>
               </div>
