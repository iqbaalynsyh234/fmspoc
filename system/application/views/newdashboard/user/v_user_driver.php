  ...
  <div class="page-content">
    ...
    <div class="col-md-12">
      <div class="panel" id="panel_form">
        <header class="panel-heading" style="background-color:#221f1f;color:white;">Driver Account</header>
          ...
          <table id="example1" class="table table-striped" style="font-size: 14px; width:100%;">
            <thead>
              <tr>
                <th>
                  ...
                  <?php } else { ?>
                    <a type="button" class="btn btn-success btn-xs" href="<?php echo base_url() ?>account/addnewdriver" title="Add User">
            ...
            <tbody>
              ...
              for ($i = 0; $i < count($data); $i++) { ?>
                <tr>
                  <td valign="top"><?= $no; ?></td>
                  <td valign="top">C-<?= $data[$i]['user_login']; ?></td>
                  ...
                  <?php } else { ?>
                    <td>
                      <a href="<?= base_url(); ?>account/editdriver/<?= $data[$i]['user_id']; ?>"><img src="<?= base_url(); ?>assets/images/edit_male_user.png" border="0" width="32" alt="<?= $this->lang->line("ledit_data"); ?>" title="<?= $this->lang->line("ledit_data"); ?>"></a>
