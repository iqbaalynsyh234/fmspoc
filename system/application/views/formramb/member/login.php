...
<html lang="en">
  <head>
  	<title>PT. RIZKY ARTHA MULIA BERSUJUD</title>
    <meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/formramb/css/style.css">

	<style>
	body {
		background-image: url(assets/formramb/images/bg.jpg);
		}
...
.form-control {
		...
		<div class="container" style="border:0px solid black; margin-top:-100px;">
			<div class="row justify-content-center" style="margin-top:70px;">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" ><img src="<?php echo base_url(); ?>assets/formramb/images/logoramb.png"></h2>
					<!--<h2 class="heading-section text-center">PT. RIZKY ARTHA MULIA BERSUJUD</h2>-->
				</div>
			</div>
  ...
  <script src="<?php echo base_url(); ?>assets/formramb/js/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formramb/js/popper.js"></script>
  <script src="<?php echo base_url(); ?>assets/formramb/js/bootstrap.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formramb/js/main.js"></script>
