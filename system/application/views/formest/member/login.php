...
<html lang="en">
  <head>
  	<title>PT. ENERGI SINAR TAMBANG</title>
    <meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/formest/css/style.css">

	<style>
	body {
		background-image: url(assets/formest/images/bg.jpg);
		}
...
.form-control {
		...
		<div class="container" style="border:0px solid black; margin-top:-100px;">
			<div class="row justify-content-center" style="margin-top:70px;">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" ><img src="<?php echo base_url(); ?>assets/formest/images/icon.png"></h2>
					<!--<h2 class="heading-section text-center">PT. ENERGI SINAR TAMBANG</h2>-->
				</div>
			</div>
  ...
  <script src="<?php echo base_url(); ?>assets/formest/js/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formest/js/popper.js"></script>
  <script src="<?php echo base_url(); ?>assets/formest/js/bootstrap.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formest/js/main.js"></script>
