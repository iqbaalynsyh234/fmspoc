...
<html lang="en">
  <head>
  	<title>KOPERASI SERBA USAHA MITRA BERSATU</title>
    <meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/formkmb/css/style.css">

	<style>
	body {
		background-image: url(assets/formkmb/images/bg.jpg);
		}
...
.form-control {
		...
		<div class="container" style="border:0px solid black; margin-top:-100px;">
			<div class="row justify-content-center" style="margin-top:70px;">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" ><img src="<?php echo base_url(); ?>assets/formkmb/images/logokmb.png"></h2>
					<!--<h2 class="heading-section text-center">KOPERASI SERBA USAHA MITRA BERSATU</h2>-->
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form class="signin-form" id="frmlogin" name="frmlogin" onsubmit="javascript : return frmlogin_onsubmit(this);">
					...
					<div class="form-group">
						<button type="submit" class="form-control btn-primary submit px-3" style="background-color:green; opacity:0.7"><font color="white">LOG IN </font></button>
  ...
  <script src="<?php echo base_url(); ?>assets/formkmb/js/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formkmb/js/popper.js"></script>
  <script src="<?php echo base_url(); ?>assets/formkmb/js/bootstrap.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formkmb/js/main.js"></script>
