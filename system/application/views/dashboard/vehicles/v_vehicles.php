                ...
                <tbody>
                  <?php for($i=0;$i<count($datavehicle);$i++) { ?>
                    <tr>
                      ...
                      <td><?=$datavehicle[$i]['vehicle_mdt'];?></td>
                      <td>
                        ...
                        <!-- <a  href="javascript:vformfuel(<?php echo $datavehicle[$i]['vehicle_id'];?>)">
                          <button class="btn btn-warning btn-sm" alt="<?php echo "Fuel Calibration"; ?>" title="Fuel Calibration">
                        ...
                        <!-- <a  href="javascript:vehiclemdt(<?php echo $datavehicle[$i]['vehicle_id'];?>)">
                          <button class="btn btn-success btn-sm" alt="<?php echo "Update MDT Imei"; ?>" title="Update MDT Imei">
