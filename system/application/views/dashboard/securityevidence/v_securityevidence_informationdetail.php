          ...
          <div class="row">
                    ...
                    <tr>
                      ...
                      <td>
                        <i class="fa fa-warning">
                          <span id="alerttype" style="color:red; font-size:14px;"><?php echo $content[0]['alarm_report_name'] ?></span><br>
                        </i>
                        <i class="fa fa-warning">
                    			<?php
                    ...
                    <tr>
                      ...
                      <td>
                        <i class="fa fa-clock-o">
                          <span id="alerttime"><?php echo date("d-m-Y H:i:s", strtotime($content[0]['alarm_report_end_time'])+60*60) ?></span>
                        </i>
                      </td>
                    </tr>
            ...
            <div class="col-md-6">
              <div class="card-box">
                <div class="card-body">
                  <?php
                  $alarmtype = $content[0]['alarm_report_type'];
                    if ($alarmtype == 631) {?>
                      <div class="row">
                        <div class="col-md-8">
                          <table>
              							<tr>
              							  <td>
              								<i class="fa fa-user">
              								  <span id="alertdriver">Driver Name : None</span>
              								</i>
              							  </td>
              							</tr>
              							<tr>
              							  <td>
              								<i class="fa fa-phone">
              								  <span id="alertdriverphone">Contact Info : None</span>
              								</i>
              							  </td>
              							</tr>
              							<tr>
              							  <td>
              								<i class="fa fa-drivers-license">
              								  <span id="alertdriverlicense">License : None</span>
              								</i>
              							  </td>
              							</tr>
              						</table>
