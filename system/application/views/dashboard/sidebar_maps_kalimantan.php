                    ...
                    <ul class="sub-menu">
                      ...
                      <?php
                          ...
                          $lastengine = "";
                            ...
                            if ($vehicledata[$i]['vehicle_mv03'] != "0000") {
                              $view_status = "video";
                            }else {
                              $view_status = "";
                            }
                            $datajson = $this->dashboardmodel->getjson_status2($vehicledata[$i]['vehicle_device']);
                                ...
                                if($lastspeed > 0){
                                  $vehiclenamecolor = '<i class=""></i><small style="color: lightgreen;">'.$vehicledata[$i]['vehicle_no'].' '.$vehicledata[$i]['vehicle_name'].'</small>';
                                }else{
                                  $vehiclenamecolor = '<i class=""></i><small>'.$vehicledata[$i]['vehicle_no'].' '.$vehicledata[$i]['vehicle_name'].'</small>';
                                }
                          ...
                          <?php }else {?>
                            <li class="nav-item">
                              ...
                              if($datajson != ""){
                               ...
                               ?>
                              <a href="#" class="nav-link nav-toggle">
                                <?php echo $vehiclenamecolor ?>
                                <span class="arrow"></span>
                              </a>
                              <ul class="sub-menu">
                                <li class="nav-item">
                                  <a href="#" class="nav-link" onclick="forgetcenter2('<?=$vehicledata[$i]['vehicle_device'];?>')">
                                ...
                                <li class="nav-item">
                                  <?php
                                  if ($view_status == "video") {?>
                                    <a href="#" class="nav-link" onclick="getthevideo('<?=$vehicledata[$i]['vehicle_mv03'];?>','<?=$vehicledata[$i]['vehicle_device'];?>')">
                            ...
                            <!-- <li class="nav-item">
                              <a href="#" class="nav-link" onclick="forgetcenter2('<?=$vehicledata[$i]['vehicle_device'];?>')"><small><?=$vehicledata[$i]['vehicle_no'].' '.$vehicledata[$i]['vehicle_name'].' <br>';?> </small></a>
                            </li>

                            <li class="nav-item">
                              <a href="#" class="nav-link" onclick="getthevideo('<?=$vehicledata[$i]['vehicle_mv03'];?>','<?=$vehicledata[$i]['vehicle_device'];?>')"><small><?=$view_status;?> </small></a>
                            </li> -->
                          <?php } ?>
                      <?php }} ?>
                    </ul>
                      ...
                      <ul class="sub-menu">
                        ...
                        <?php for ($k=0; $k < sizeof($vehicle[$j]['vehicle']); $k++) {?>
                          ...
                          $lastengine = "";
                            ...
                            if ($vehicle[$j]['vehicle'][$k]->vehicle_mv03 != "0000") {
                              $view_status = "video";
                            }else {
                              $view_status = "";
                            }
                            $datajson = $this->dashboardmodel->getjson_status2($vehicle[$j]['vehicle'][$k]->vehicle_device);
														if($datajson != ""){
															// if($datajson->auto_last_speed > 0){
																...
																$lastspeed  = round($datajson->auto_last_speed)." kph";
                                if($lastspeed > 0){
                                  $vehiclenamecolor = '<i class=""></i><small style="color: lightgreen;">'.$vehicle[$j]['vehicle'][$k]->vehicle_no.' '.$vehicle[$j]['vehicle'][$k]->vehicle_name.'</small>';
                                }else{
                                  $vehiclenamecolor = '<i class=""></i><small>'.$vehicle[$j]['vehicle'][$k]->vehicle_no.' '.$vehicle[$j]['vehicle'][$k]->vehicle_name.'</small>';
                                }
																// if($lastspeed > 0){
																// 	$view_status = "<font color='yellow'>".$lastspeed." Moving </font>";
																// }else{
                          ...
                          <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                              <li class="nav-item">
                                <a href="#" class="nav-link" onclick="forgetcenter2('<?=$vehicle[$j]['vehicle'][$k]->vehicle_device;?>')">
                                  <span class="fa fa-map-marker"></span>
                                  <small>Position</small>
                                </a>
                              </li>
                              <li class="nav-item">
                                <?php
                                if ($view_status == "video") {?>
                                  <a href="#" class="nav-link" onclick="getthevideo('<?=$vehicle[$j]['vehicle'][$k]->vehicle_mv03;?>','<?=$vehicle[$j]['vehicle'][$k]->vehicle_device;?>')">
                                    <span class="fa fa-video-camera"></span>
                                    <small>Streaming</small>
                                  </a>
                                <?php }?>
                          ...
                          <!-- <li class="nav-item">
                            <a href="#" class="nav-link-togle" onclick="forgetcenter2('<?=$vehicle[$j]['vehicle'][$k]->vehicle_device;?>')">
                              <small><?=$vehicle[$j]['vehicle'][$k]->vehicle_no . ' ' .$vehicle[$j]['vehicle'][$k]->vehicle_name.'<br>';?></small>
                            </a>
                            <a href="#" class="nav-link-togle" onclick="getthevideo('<?=$vehicle[$j]['vehicle'][$k]->vehicle_mv03;?>','<?=$vehicle[$j]['vehicle'][$k]->vehicle_device;?>')">
                              <small><?=$view_status;?></small>
                            </a>
                              <span class="arrow"></span>
                          </li> -->
                        <?php } ?>
            ...
            <li class="nav-item">
              ...
              <ul class="sub-menu">
                ...
                <?php for ($k=0; $k < sizeof($vehicle[$j]['vehicle']); $k++) {?>
                  ...
                  <!-- <li class="nav-item">
                    <a href="#" class="nav-link-togle" onclick="forgetcenter2('<?=$vehicle[$j]['vehicle'][$k]->vehicle_device;?>')">
                      <small><?=$vehicle[$j]['vehicle'][$k]->vehicle_no . ' <br> ';?></small></a>
                    </a>
                    <a href="#" class="nav-link-togle" onclick="getthevideo('<?=$vehicle[$j]['vehicle'][$k]->vehicle_mv03;?>','<?=$vehicle[$j]['vehicle'][$k]->vehicle_device;?>')">
                      <small><?=$view_status;?></small>
                    </a>
