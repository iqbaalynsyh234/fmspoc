    ...
    require.config({
        ...
        b.setOption({
            ...
            series: [{
				...
				name: "NewData",
                type: "bar",
                data: [56.9, 34, 43, 45, 26.3,78.9, 45, 67.9, 60.8, 18.8, 7, 5]
			}]
        });
                ...
                <div class="page-content">
                    <!--<div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Safety Board</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="<?=base_url();?>">Safety Board</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
					...
					<div class="row">	
						<div class="col-xl-3 col-md-1 col-6" style="cursor:pointer;" onclick="armingfeature();">
