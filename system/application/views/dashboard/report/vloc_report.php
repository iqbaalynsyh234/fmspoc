...
function page(p)
	{
		...
		jQuery("#loader2").show();
		jQuery.post("<?=base_url();?>locationreport/search", jQuery("#frmsearch").serialize(),
			function(r)
			{
				if (r.error) {
					alert(r.message);
                    ...
                    <div class="row">
						<div class="col-md-12 col-sm-12">
                            <div class="panel" id="panel_form">
                                <header class="panel-heading panel-heading-blue">LOCATION REPORT</header>
                                <div class="panel-body" id="bar-parent10">
                                    <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
										<div class="form-group row">
											<label class="col-lg-3 col-md-3 control-label">Area/Group
                                            </label>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-3 col-md-4">
												...
												<div id="speed_view" style="display:none">
													Speed : <input class="form-control" type="text" name="statusspeed" id="statusspeed" value="" size="50" placeholder="Ex: 10"/>
												</div>
											</div>
										</div>
