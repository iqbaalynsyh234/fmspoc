	 ...
	 <?php
		if(isset($data) && (count($data) > 0)){
				...
				<tr>
					...
					<td style="text-align:center;font-size:12px;"><?php echo date("d-m-Y", strtotime($data[$i]->brake_report_gps_time));?></td>
					<td style="text-align:center;font-size:12px;"><?php echo date("H:i:s", strtotime($data[$i]->brake_report_gps_time));?></td>
					<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->brake_report_vehicle_no;?></td>
					<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->brake_report_vehicle_name;?></td>
					<!--<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->brake_report_name;?></td>-->
					<!--<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->brake_report_location;?></td>-->
					<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->brake_report_coordinate;?></td>
					<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->brake_report_speed;?></td>
					<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->brake_report_geofence_name;?></td>
					<!--<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->brake_report_geofence_limit;?></td>-->
					<td style="text-align:center;font-size:12px;"><?php echo $data[$i]->brake_report_jalur;?></td>
				</tr>
		<?php
				}
