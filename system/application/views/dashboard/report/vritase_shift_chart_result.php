...
jQuery(document).ready(function() {
	var dataname =  '<?php echo json_encode($content_name_one); ?>';
	var dataname_fix = JSON.parse(dataname);
	
	var data =  '<?php echo json_encode($content_one); ?>';
	var data_fix = JSON.parse(data);
	
	var dataname_two =  '<?php echo json_encode($content_name_two); ?>';
	var dataname_fix_two = JSON.parse(dataname_two);
	
	var data_two =  '<?php echo json_encode($content_two); ?>';
	var data_fix_two = JSON.parse(data_two);
					...
					<div class="row">	
					 <div class="col-md-12">
                            <div class="card card-topline-red">
                                <div class="card-head">
                                    <header>Top <?=$limitdata;?> Ritase by Shift 1</header>
                                    <div class="tools">
						...
						<div class="col-md-12">
                            <div class="card card-topline-red">
                                <div class="card-head">
                                    <header>Top <?=$limitdata;?> Ritase by Shift 2</header>
                                    <div class="tools">
										<a class="t-collapse btn-color fa fa-chevron-down" href="javascript:;"></a>
										<a class="t-close btn-color fa fa-times" href="javascript:;"></a>
                                    </div>
