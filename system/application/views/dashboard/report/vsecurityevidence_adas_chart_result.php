...
jQuery(document).ready(function() {
	...
	var dataname_street =  '<?php echo json_encode($content_name_street); ?>';
	var dataname_fix_street = JSON.parse(dataname_street);
	
	var data_street =  '<?php echo json_encode($content_street); ?>';
	var data_fix_street = JSON.parse(data_street);
					...
					<div class="row">	
					 <div class="col-md-12">
                            <div class="card card-topline-red">
                                <div class="card-head">
                                    <header>Top <?=$limitdata;?> ADAS Alarm by Vehicle</header>
                                    <div class="tools">
						...
						<div class="col-md-12">
                            <div class="card card-topline-red">
                                <div class="card-head">
                                    <header>Top <?=$limitdata;?> ADAS Alarm by Location</header>
                                    <div class="tools">
										<a class="t-collapse btn-color fa fa-chevron-down" href="javascript:;"></a>
										<a class="t-close btn-color fa fa-times" href="javascript:;"></a>
                                    </div>
