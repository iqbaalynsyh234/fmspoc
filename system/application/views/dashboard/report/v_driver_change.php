<script>
	function page(p)
	{
		...
		jQuery.post("<?=base_url();?>driverchange/search/", data, function(r){
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12">
        <div class="panel" id="panel_form">
          <header class="panel-heading panel-heading-blue">Driver Change Report</header>
          <div class="panel-body" id="bar-parent10">
            <form class="form-horizontal form" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
        			...
        			<input type="hidden" id="orderby" name="orderby" value="" />
							...
							<table class="table">
								<tr>
									<td style="font-size:12px;">Vehicle</td>
									<td>
										<select id="vehicle" name="vehicle" class="form-control select2">
											<option value="0">All</option>
											<?php for($i=0; $i < count($vehicles); $i++) { ?>
											<option value="<?php echo $vehicles[$i]->vehicle_mv03; ?>"><?php echo $vehicles[$i]->vehicle_no; ?></option>
											<?php } ?>
										</select>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<select id="driver" name="driver" class="form-control select2">
											...
											<option value="<?php echo $drivers[$i]->driver_idcard; ?>"><?php echo $drivers[$i]->driver_name;?></option>
											<?php } ?>
										</select>
									</td>
								</tr>
								...
								<tr>
									<td style="font-size:12px;">Start Date</td>
									<td>
								...
								<tr>
									<td style="font-size:12px;">End Date</td>
									<td>
										<div class="input-group date form_date col-md-6" data-date="" data-date-format="dd-mm-yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
