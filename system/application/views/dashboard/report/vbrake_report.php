        ...
        <div class="panel" id="panel_form">
          ...
          <div class="panel-body" id="bar-parent10">
            <form class="form-horizontal" name="frmsearch" id="frmsearch" onsubmit="javascript:return frmsearch_onsubmit()">
              ...
              <div class="form-group row" id="mn_vehicle">
                <label class="col-lg-3 col-md-3 control-label">Speed
                </label>
                <div class="col-lg-4 col-md-4">
                  <select id="speedfilterbrake" name="speedfilterbrake" class="form-control">
                    <option value="0">0 Kph</option>
                    <option value="1">> 0 Kph</option>
                  </select>
                </div>
              </div>
