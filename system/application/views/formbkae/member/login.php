...
<html lang="en">
  <head>
  	<title>PT. BERJASA KALIMANTAN ABADI ENERGI</title>
    <meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/formbkae/css/style.css">

	<style>
	body {
		background-image: url(assets/formbkae/images/bg.jpg);
		}
...
.form-control {
		...
		<div class="container" style="border:0px solid black; margin-top:-100px;">
			<div class="row justify-content-center" style="margin-top:70px;">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" ><img src="<?php echo base_url(); ?>assets/formbkae/images/logobkae.png"></h2>
					<!--<h2 class="heading-section text-center">PT. BERJASA KALIMANTAN ABADI ENERGI</h2>-->
				</div>
			</div>
  ...
  <script src="<?php echo base_url(); ?>assets/formbkae/js/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formbkae/js/popper.js"></script>
  <script src="<?php echo base_url(); ?>assets/formbkae/js/bootstrap.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formbkae/js/main.js"></script>
