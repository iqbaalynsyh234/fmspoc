...
<html lang="en">
  <head>
  	<title>CV. MEGA KARYA SAHABAT</title>
    <meta charset="utf-8">
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/formmks/css/style.css">
...
.form-control {
		...
		<div class="container" style="border:0px solid black; margin-top:-100px;">
			<div class="row justify-content-center" style="margin-top:70px;">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" ><img src="<?php echo base_url(); ?>assets/formmks/images/logomks.png"></h2>
  ...
  <script src="<?php echo base_url(); ?>assets/formmks/js/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formmks/js/popper.js"></script>
  <script src="<?php echo base_url(); ?>assets/formmks/js/bootstrap.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/formmks/js/main.js"></script>
