...
class Ritasereport2 extends Base
{
	var $otherdb;

	function Ritasereport2()
	{
		parent::Base();
	...
	function index()
	{
		...
		if ($privilegecode == 1) {
			...
			$this->params["content"]        = $this->load->view('newdashboard/ritase/v_ritase_report', $this->params, true);
	...
	function search()
	{
		...
		$html = $this->load->view("newdashboard/ritase/v_ritase_report_result", $params, true);
