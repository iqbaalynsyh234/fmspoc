...
class History_lacakmobil extends Base {
...
function clear_multiport($servername="")
	...
	function daily_alert_dblive($dblive="",$maxdata=5000, $offset = 0)
	{
		ini_set('memory_limit', '2G');
		$start_time = date("d-m-Y H:i:s");
	...
	function daily_command_dblive($dblive="",$maxdata=5000, $offset = 0)
	{
		ini_set('memory_limit', '2G');
		$start_time = date("d-m-Y H:i:s");
	...
	function daily_ritase_dblive($dblive="",$maxdata=5000, $offset = 0)
	{
		ini_set('memory_limit', '2G');
		$start_time = date("d-m-Y H:i:s");
	...
	function daily_respon_dblive($dblive="",$maxdata=5000, $offset = 0)
	{
		ini_set('memory_limit', '2G');
		$start_time = date("d-m-Y H:i:s");
