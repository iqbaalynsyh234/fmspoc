<?php
	...
	*/
	...
	$config['street_register'] = array(					"PORT BIB","PORT BIR","PORT TIA","PORT BBC",
														...
														"ROM B1 ROAD","ROM B2 ROAD","EST ROAD",
														//"POOL BBS","POOL BKA","POOL BSL","POOL GECL","POOL MKS","POOL RAM","POOL RBT","POOL STLI","POOL RBT BRD","POOL GECL2",
														//"WS GECL","WS KMB","WS MKS","WS RBT","WS MMS","WS EST","WS EST 32","WS KMB INDUK","WS GECL 3","WS BRD","WS BEP",
														...
														"Port BIR - Kosongan 1","Port BIR - Kosongan 2","Simpang Bayah - Kosongan","Port BIB - Kosongan 2","Port BIB - Kosongan 1","Port BIR - Antrian WB",
														"PORT BIB - Antrian");
														
														
	$config['redzone_register'] = array("STU area", "Jalur TIA Utara","Jalur TIA Selatan","PCN area",
										"Non BIB KM 11","Non BIB KM 9","Non BIB Simp Telkom"
										);
	$config['street_register_all'] = array("PORT BIB","PORT BIR","PORT TIA","PORT BBC",
														"ST1","ST2","ST3","ST4","ST5","ST6","ST7","ST8","ST9","ST10","ST11","ST12",
														"ROM A1","ROM A2","ROM B1","ROM B2","ROM B3","ROM EST",
														"ROM B1 ROAD","ROM B2 ROAD","EST ROAD",
														"POOL BBS","POOL BKA","POOL BSL","POOL GECL","POOL MKS","POOL RAM","POOL RBT","POOL STLI","POOL RBT BRD","POOL GECL2",
														...
														"KM 16.5","KM 17","KM 17.5","KM 18","KM 18.5","KM 19","KM 19.5","KM 20","KM 20.5","KM 21","KM 21.5","KM 22","KM 22.5","KM 23","KM 23.5","KM 24","KM 24.5","KM 25","KM 25.5","KM 26",
														"KM 26.5","KM 27","KM 27.5","KM 28","KM 28.5","KM 29","KM 29.5","KM 30","KM 30.5","KM 31","KM 31",
														"BIB CP 1","BIB CP 7","BIB CP 3","BIB CP 4","BIB CP 5","BIB CP 2","BIB CP 6","BIR Ant.S LS","BIR Ant.S LS 2","BIR LS","BIR Ant BLC","BIR Ant BLC 2",
														"Port BIR - Kosongan 1","Port BIR - Kosongan 2","Simpang Bayah - Kosongan","Port BIB - Kosongan 2","Port BIB - Kosongan 1","Port BIR - Antrian WB",
														"PORT BIB - Antrian");
