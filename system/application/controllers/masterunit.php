  ...
  function index()
	{
		...
		$this->params['datafromportal'] = $this->m_masterdata->getFromMasterUnit();
		...
		if ($privilegecode == 1) {
			...
			$this->params["content"]        = $this->load->view('newdashboard/masterfromportal/v_home_masterunit', $this->params, true);
