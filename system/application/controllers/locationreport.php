...
class Locationreport extends Base {
	var $otherdb;
    ...
    $privilegecode 	 = $this->sess->user_id_role;
		...
		$this->params["chatsidebar"]    = $this->load->view('newdashboard/partial/chatsidebar', $this->params, true);
			...
			if ($privilegecode == 1) {
				...
				$this->params["content"]        = $this->load->view('newdashboard/report/vloc_report', $this->params, true);
	...
	function search()
	{
		...
		// echo "<pre>";
		// var_dump($company.'-'.$sdate.'-'.$edate);die();
		// echo "<pre>";
		...
		$html                  = $this->load->view("newdashboard/report/vloc_result", $params, true);
