...
class Fuelopr extends Base {
	...
	function index()
	{
		...
		$this->params["content"] = $this->load->view('dashboard/report/voprfuel_report', $this->params, true);
...
//		ini_set('memory_limit', '2G');
		...
		//$report = "operasional_";
		$report = "fuel_location_"; // new report
		$report_sum = "summary_";
		...
		$html = $this->load->view("dashboard/report/voprfuel_result", $params, true);
