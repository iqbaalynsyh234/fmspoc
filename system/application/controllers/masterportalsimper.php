...
class Masterportalsimper extends Base {
  ...
  function index()
    ...
    $this->params['datafromportal'] = $this->m_masterdata->getFromPortalSimper();
    ...
    // echo "<pre>";
		...
		if ($privilegecode == 1) {
			...
			$this->params["content"]        = $this->load->view('newdashboard/masterfromportal/v_home_masterportal_simper', $this->params, true);
	...
	function getimage(){
		$portal_id_number = $_POST['portal_id_number'];
		$data             = $this->m_masterdata->getdataimage("ts_bib_master_portal_simper", $portal_id_number);
