...
function clear_multiport($servername="")
	...
	function daily_respon_dblive($dblive="",$maxdata=10000, $offset = 0)
	{
		...
		$this->db->order_by("vehicle_id","asc");
		$this->db->where("vehicle_dbname_live", $dblive);
		/* $this->db->where ("vehicle_device <>", "869926046531113@VT200");
		$this->db->where ("vehicle_device <>", "869926046536377@VT200");
		$this->db->where ("vehicle_device <>", "869926046522328@VT200");
		$this->db->where ("vehicle_device <>", "869926046499253@VT200");
		$this->db->where ("vehicle_device <>", "869926046494585@VT200");
		$this->db->where ("vehicle_device <>", "869926046502585@VT200");
		$this->db->where ("vehicle_device <>", "869926046502965@VT200");
		$this->db->where ("vehicle_device <>", "869926046537706@VT200");
		$this->db->where ("vehicle_device <>", "869926046527814@VT200");
		$this->db->where ("vehicle_device <>", "869926046500746@VT200");
		$this->db->where ("vehicle_device <>", "869926046531659@VT200");
		$this->db->where ("vehicle_device <>", "869926046498552@VT200"); */
		//$this->db->where("vehicle_status <>",3);
		$this->db->select("vehicle_type, vehicle_device, vehicle_dbname_live");
