...
class Driverbreakdown extends Base {
	var $period1;
	var $period2;
	var $tblhist;
	var $tblinfohist;
  ...
  function index(){
		...
		if ($privilegecode == 1) {
			...
			$this->params["content"]        = $this->load->view('newdashboard/driverbreakdown/v_home_driverbreakdown', $this->params, true);
  ...
  function searchthis(){
    ...
    $datasearch 						= $this->m_poipoolmaster->searchthisbreakdown("ts_driver_breakdown", $driver, $vehicle, $sdate, $edate);
    ...
    // echo "<pre>";
		...
		$html                            = $this->load->view('newdashboard/driverbreakdown/v_driverbreakdown_result', $this->params, true);
		$callback['html']                = $html;
