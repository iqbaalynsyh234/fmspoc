						...
						if($rowvehicle->vehicle_status != 3)
						{
								...
								if(isset($gps->gps_timestamp))
								{
									...
									if (in_array($street_name, $bayah_muatan_register))
									{
										$jalur = "muatan";
										$hauling = "in";
										$alert_out_port = $this->outofport_alert($rowvehicle,$street_name,date("Y-m-d H:i:s", $gps_realtime),$coordinate);
									...
									if($hauling == 'out'){
										...
										$alert_out_hauling = $this->outofgeofence_alert($rowvehicle,$street_name,date("Y-m-d H:i:s", $gps_realtime),$coordinate);
									}
...
"
	...
	function outofgeofence_alert($vehicle,$location,$gpstime,$coordinate){
	...
	function outofport_alert($vehicle,$location,$gpstime,$coordinate){
