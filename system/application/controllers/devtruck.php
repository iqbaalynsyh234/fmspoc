...
class Devtruck extends Base
{
    ...
    function hour()
    {
        ...
        if ($privilegecode == 1) {
            ...
            $this->params["content"]        = $this->load->view('newdashboard/truckhour/v_dev_truck_hour', $this->params, true);
    ...
    function pool()
    {
        ...
        $rows_company                   = $this->get_company_pool();
