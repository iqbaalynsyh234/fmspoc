...
class Ugapi extends Base {
	...
	function req_alarmevidence()
	{
		//printf("PROSES POST SAMPLE -> REQUEST >> LAST POSITION \r\n");

		$token = "UGaW5kNkjhA782GBNS1616KbswQYa5372bsdexVNT16";
		$authorization = "Authorization:".$token;
		$url = "https://temanbib.borneo-indobara.com/ugapi/getalarmevidence";
		$feature = array();

		$feature["UserId"] = 4204; //pbi
		//$feature["VehicleNo"] = "all";
		$feature["VehicleNo"] = "STL 3570";
		$feature["MediaType"] = "1";
		$feature["StartTime"] = "2022-08-20 00:00:00";
