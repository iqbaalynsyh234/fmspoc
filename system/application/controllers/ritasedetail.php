...
class Ritasedetail extends Base
{
    var $otherdb;

    function Ritasedetail()
    {
        parent::Base();
    ...
    function index()
    {
        ...
        if ($privilegecode == 1) {
            ...
            $this->params["content"]        = $this->load->view('newdashboard/ritase/v_ritase_detail', $this->params, true);
    ...
    function search()
    {
        ...
        $html = $this->load->view("newdashboard/ritase/v_ritase_detail_result", $params, true);
