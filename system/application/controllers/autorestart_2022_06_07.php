						...
						if($rowvehicle->vehicle_status != 3)
						{
								...
								if(isset($gps->gps_timestamp))
								{
									...
									$rom_register = array("ROM A1","ROM A2","ROM B1","ROM B2","ROM B3","ROM EST","PIT CK",
														  "Non BIB KM 11","Non BIB KM 9","Non BIB Simp Telkom", "Non BIB Angsana"
										
													      
														  );
														  
									$nonbib_register = array("SUNGAI DANAU","KINTAB","sungai danau","kintab","Non BIB Angsana"
																);
...
"
	...
	function autocheck_hour_data_tes($userid="", $order="asc")
	{
		date_default_timezone_set("Asia/Jakarta");
		$nowdate = date('Y-m-d');
		$nowtime = date('Y-m-d H:i:s');
